...
<div class="lp-wrap">
  ...
  <div class="lp-brand">
    ...
    <div class="lp-pitch">
      <div class="lp-badge"><span class="dot"></span><?php echo $this->lang->line('user_login') ?: 'User Portal'; ?></div>
    </div>
  ...
  <div class="lp-form-panel">
    <div class="lp-card">
      ...
      <form action="<?php echo site_url('user/resetpassword/' . $role . '/' . $verification_code); ?>" method="post" class="lp-form">
        <?php echo $this->customlib->getCSRF(); ?>

        <div>
          <label class="lp-label" for="ur-password"><?php echo $this->lang->line('password'); ?></label>
          <input type="password" id="ur-password" name="password" class="lp-input" placeholder="<?php echo $this->lang->line('password'); ?>" autocomplete="new-password">
          <span class="text-danger"><?php echo form_error('password'); ?></span>
        </div>

        <div>
          <label class="lp-label" for="ur-confirm-password"><?php echo $this->lang->line('confirm_password'); ?></label>
          <input type="password" id="ur-confirm-password" name="confirm_password" class="lp-input" placeholder="<?php echo $this->lang->line('confirm_password'); ?>" autocomplete="new-password">
      ...
      <div class="lp-card-alt">
        <a href="<?php echo site_url('site/userlogin'); ?>" class="lp-back-link">
          ...
          <?php echo $this->lang->line('user_login'); ?>
        </a>
      </div>
    </div>
  </div>
