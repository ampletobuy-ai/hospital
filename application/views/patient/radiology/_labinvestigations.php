...
<div class="sh-form-card">
    ...
    <div class="table-responsive">
        <table class="table table-sm table-hover mb-0">
            ...
            <tbody>
                <?php $row_counter = 1; foreach ($result->radiology_parameter as $parameter_value): ?>
                <tr>
                    ...
                    <td><?php if ($parameter_value->radiology_report_value != '') echo html_escape($parameter_value->radiology_report_value . ' ' . $parameter_value->unit_name); ?></td>
                </tr>
                <?php endforeach; ?>
                <?php if (!empty($parameter_value->radiology_result)): ?>
                <tr>
                    <td colspan="4"><strong><?php echo $this->lang->line('result'); ?>:</strong> <?php echo nl2br(html_escape($parameter_value->radiology_result)); ?></td>
                </tr>
                <?php endif; ?>
            </tbody>
        </table>
