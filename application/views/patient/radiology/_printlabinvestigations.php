                    ...
                    <div class="sh-flex-gap18">
                        <table class="sh-print-info-table w-50" >
                            ...
                            <tr>
                                ...
                                <td><?php echo $this->customlib->getPatientSessionPrefixByType('radiology_billing') . $result->radiology_bill_id; ?></td>
                            </tr>
                            <tr>
                        ...
                        <table class="sh-print-info-table w-50" >
                            ...
                            <tr>
                                ...
                                <td><?php echo ($result->reporting_date ? $this->customlib->YYYYMMDDTodateFormat($result->reporting_date) : '-'); ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php echo $level_exceeded
                                    ...
                                    : $parameter_value->radiology_report_value . ' ' . $parameter_value->unit_name; ?>
                            </td>
                        </tr>
                        <?php $row_counter++; } ?>
                        ...
                        <tr>
                            <td colspan="4">
                                ...
                                <?php echo nl2br($parameter_value->radiology_result); ?>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
