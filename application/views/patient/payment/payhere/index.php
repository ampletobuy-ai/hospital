...
<div class="container-fluid px-1 py-1">
        <div class="row g-3">
            ...
            <!-- RIGHT: payment card — amount breakdown + PayHere redirect.
                 PayHere takes no customer fields here: the form POSTs to payhere/pay,
                 which builds the signed form and renders the auto-submit bridge
                 (pay.php → payhere.lk). -->
            <div class="col-md-5">
