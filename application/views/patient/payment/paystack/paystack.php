...
<div class="container-fluid px-1 py-1">
        <div class="row g-3">
            ...
            <!-- RIGHT: payment card — amount breakdown + email + Paystack redirect.
                 Paystack's API requires a customer email to initialize the charge. -->
            <div class="col-md-5">
                    ...
                    <div class="p-3">
                        ...
                        <form action="<?php echo base_url(); ?>patient/payment/paystack/pay" method="post">
                            <div class="form-group mt-3">
                                <label for="email" class="form-label"><?php echo $this->lang->line('email'); ?> <small class="req text-danger">*</small></label>
