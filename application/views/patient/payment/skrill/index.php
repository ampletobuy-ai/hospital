...
<div class="container-fluid px-1 py-1">
        <div class="row g-3">
            ...
            <!-- RIGHT: payment card — amount breakdown + email/phone + Skrill redirect.
                 The form POSTs to skrill/pay, which renders the auto-submit bridge
                 (pay.php → pay.skrill.com) once email/phone validate. -->
            <div class="col-md-5">
                        ...
                        <form action="<?php echo base_url(); ?>patient/payment/skrill/pay" method="post">
                            ...
                            <div class="sh-pay-actions">
                                ...
                                <button type="submit" class="btn btn-primary btn-pay submit_button">
                                    <i class="fa fa-lock me-1"></i><?php echo $this->lang->line('pay_with_skrill') ?>
                                </button>
                            </div>
                        </form>
