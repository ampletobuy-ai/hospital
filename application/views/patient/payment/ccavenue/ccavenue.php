...
<div class="container-fluid px-1 py-1">
        <div class="row g-3">
            ...
            <!-- RIGHT: payment card — amount breakdown + CCAvenue redirect.
                 The form POSTs to /pay, which renders an invisible auto-submitting
                 bridge form that forwards the encrypted request to CCAvenue. -->
            <div class="col-md-5">
