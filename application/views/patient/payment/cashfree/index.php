...
<div class="container-fluid px-1 py-1">
        <div class="row g-3">
            ...
            <!-- RIGHT: payment card — amount breakdown + email/phone + Cashfree redirect.
                 Cashfree's order API requires customer email and phone to build the
                 order, so both are required. The form POSTs to cashfree/pay, which
                 redirects to the hosted payment_link (or re-renders this view with
                    ...
                    <div class="p-3">
                        ...
                        <div class="sh-pay-summary mb-2">
                            ...
                            <div class="pay-row pay-total">
                                ...
                                <span class="val"><?php echo number_format(((float)$gateway_processing_charge + (float)$amount), 2, '.', ''); ?></span>
                            </div>
                        </div>
