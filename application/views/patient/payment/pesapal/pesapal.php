...
<div class="container-fluid px-1 py-1">
        <div class="row g-3">
            ...
            <!-- RIGHT: payment card — amount breakdown + email/phone + Pesapal redirect.
                 Pesapal's DirectOrder requires customer email and phone to build the
                 order XML, so both are required inputs. -->
            <div class="col-md-5">
