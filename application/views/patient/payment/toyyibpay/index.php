...
<div class="container-fluid px-1 py-1">
        <div class="row g-3">
            ...
            <!-- RIGHT: payment card — amount breakdown + email/phone + toyyibpay redirect.
                 toyyibpay's createBill API requires the payer email and phone, so both
                 are required. The form POSTs to toyyibpay/pay, which redirects to the
                 hosted bill (or re-renders this view with $api_error on API failure). -->
            <div class="col-md-5">
