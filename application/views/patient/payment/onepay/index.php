...
<div class="container-fluid px-1 py-1">
        <div class="row g-3">
            ...
            <!-- RIGHT: payment card — amount breakdown + OnePay redirect.
                 OnePay takes no customer fields here: the form POSTs to onepay/pay,
                 which builds the signed vpcURL and redirects to the OnePay gateway. -->
            <div class="col-md-5">
