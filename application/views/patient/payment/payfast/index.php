...
<div class="container-fluid px-1 py-1">
        <div class="row g-3">
            ...
            <!-- RIGHT: payment card — amount breakdown + email + PayFast redirect.
                 PayFast needs the customer email for the signed payload. The form
                 POSTs back to patient/payment/payfast (index), which renders the
                 auto-submit bridge (pay.php) once validation passes. -->
            <div class="col-md-5">
