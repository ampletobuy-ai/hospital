...
<!-- No .content-wrapper / section.content here: the patient layout already
     ...
     NOTE: twocheckout uses TWIN full-page views — this index.php (initial +
     validation-fail) and pay.php (success, with the 2CO inline-cart SDK).
     Both share this layout; keep them in sync. -->
<div class="container-fluid px-1 py-1">
        <div class="row g-3">
            ...
            <!-- RIGHT: payment card — amount breakdown + email/phone.
                 The form POSTs to twocheckout/pay, which re-renders this view on
                 validation failure or renders pay.php (2CO inline cart) on success. -->
            <div class="col-md-5">
