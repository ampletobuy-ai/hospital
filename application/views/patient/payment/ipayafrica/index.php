...
<div class="container-fluid px-1 py-1">
        <div class="row g-3">
            ...
            <!-- RIGHT: payment card — amount breakdown + email/phone + iPay Africa redirect.
                 iPay's hosted checkout requires the customer email (eml) and phone (tel)
                 to build the signed payload, so both are required inputs. The form POSTs
                 back to ipayafrica/index, which renders the auto-submit bridge (pay.php)
