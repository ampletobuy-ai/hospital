...
<div class="container-fluid px-1 py-1">
        <div class="row g-3">
            ...
            <!-- RIGHT: payment card — amount breakdown + JazzCash redirect.
                 JazzCash takes no customer fields here: the form just POSTs to
                 jazzcash/pay, which renders the signed auto-submit bridge
                 (jazzcashPay.php). -->
            <div class="col-md-5">
