...
<div class="container-fluid px-1 py-1">
        <div class="row g-3">
            ...
            <!-- RIGHT: payment card — amount breakdown + Walking Med credentials.
                 Walkingm logs the patient into their Walking Med wallet with email +
                 password (walkingm_lib->walkingm_login), so both are required. The
                 form POSTs to walkingm/pay, which redirects on success or re-renders
                 this view with $api_error on a login/API failure. -->
            <div class="col-md-5">
                <div class="sh-form-card h-100 mb-0">
                    ...
                    <div class="p-3">
                        ...
                        <div class="sh-pay-summary mb-2">
                            <div class="pay-row">
                                <span class="lbl"><?php echo $this->lang->line('add_amount') . ' (' . $currency_symbol . ')'; ?></span>
                        ...
                        <form action="<?php echo base_url(); ?>patient/payment/walkingm/pay" method="post">
                            <div class="form-group row mt-3 align-items-center">
                                <label for="email" class="col-sm-3 col-form-label"><?php echo $this->lang->line('walkingm_email'); ?> <small class="req text-danger">*</small></label>
                                <div class="col-sm-9">
                            ...
                            <div class="form-group row mt-2 align-items-center">
                                <label for="password" class="col-sm-3 col-form-label"><?php echo $this->lang->line('walkingm_password'); ?> <small class="req text-danger">*</small></label>
                                <div class="col-sm-9">
