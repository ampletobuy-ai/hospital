...
<div class="container-fluid px-1 py-1">
        <div class="row g-3">
            ...
            <!-- RIGHT: payment card — amount breakdown + Billplz redirect.
                 Billplz takes no customer fields here: the form POSTs to
                 billplz/pay, which creates the bill via the API and redirects
                 to the hosted bill (or re-renders this view with $api_error). -->
            <div class="col-md-5">
