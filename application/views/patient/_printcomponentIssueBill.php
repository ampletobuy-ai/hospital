...
$total_due    = $net_amount - (float)$blood_issues_detail['paid_amount'];
?>
...
<table class="table-print-full" width="100%">
    ...
    <tbody><tr><td>
        ...
        <div class="print-area">
            ...
            <!-- Title -->
            <div class="sh-print-title"><?php echo $this->lang->line('blood_bank'); ?> — <?php echo $this->lang->line('component'); ?> <?php echo $this->lang->line('bill'); ?></div>
            ...
            <div class="sh-print-info-block">
                <table class="sh-print-info-table">
                    ...
                    <tr>
                        ...
                        <td><?php echo $this->customlib->YYYYMMDDTodateFormat($blood_issues_detail['date_of_issue']); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><?php echo ($blood_issues_detail['component_name'] ? html_escape($blood_issues_detail['component_name']) : '-'); ?></td>
                    ...
                    <tr>
                        ...
                        <td colspan="3"><?php echo ($blood_issues_detail['case_reference_id'] ? html_escape($blood_issues_detail['case_reference_id']) : '-'); ?></td>
                    </tr>
                    <?php if (!empty($fields)) {
                        foreach ($fields as $fields_value) {
                            if ($fields_value->name == '') continue;
            ...
            <table class="sh-print-table">
                ...
                <tbody>
                    <tr>
                        <td>1</td>
                        <td><?php echo html_escape($blood_issues_detail['charge_categorie_name']); /* typo preserved */ ?></td>
                ...
                <tfoot>
                    ...
                    <tr>
                        ...
                        <td class="text-end"><?php echo $currency_symbol . amountFormat((float)$blood_issues_detail['paid_amount']); ?></td>
                    </tr>
