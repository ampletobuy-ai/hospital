            ...
            <div class="print-area">
                ...
                <table class="sh-print-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo date($this->customlib->getHospitalDateFormat(), $this->customlib->dateyyyymmddTodateformat($payment['date'])); ?></td>
                ...
                <table class="sh-print-table" style="width:50%; margin-left:auto;">
                    <tbody>
                        ...
                        <tr>
                            <td class="sh-text-right"><?php echo $this->lang->line('total') . ' ' . $this->lang->line('payment') . ' (' . $currency_symbol . ')'; ?></td>
                        ...
                        <tr>
                            ...
                            <td class="sh-text-right"><?php echo $currency_symbol . amountFormat((float)(empty($result['gross_total']) ? ($total - $paid_amount) : $result['gross_total'])); ?></td>
                        </tr>
                        <tr>
                            <td class="sh-text-right"><?php echo $this->lang->line('discount') . ' (' . $currency_symbol . ')'; ?></td>
                            <td class="sh-text-right"><?php echo $currency_symbol . amountFormat((float)((!empty($result['discount']) || $result['discount'] == 0) ? $result['discount'] : $discount)); ?></td>
                        </tr>
                        <tr>
                            <td class="sh-text-right"><?php echo $this->lang->line('any_other_charges') . ' (' . $currency_symbol . ')'; ?></td>
                            <td class="sh-text-right"><?php echo $currency_symbol . amountFormat((float)((!empty($result['other_charge']) || $result['other_charge'] == 0) ? $result['other_charge'] : $other_charge)); ?></td>
                        </tr>
                        <tr>
                            <td class="sh-text-right"><?php echo $this->lang->line('tax') . ' (' . $currency_symbol . ')'; ?></td>
                            <td class="sh-text-right"><?php echo $currency_symbol . amountFormat((float)((!empty($result['tax']) || $result['tax'] == 0) ? $result['tax'] : $tax)); ?></td>
                        </tr>
                        <tr class="sh-row-total">
                            <td><?php echo $this->lang->line('net_payable') . ' ' . $this->lang->line('amount') . ' (' . $status . ')'; ?></td>
                            <td><?php echo $currency_symbol . amountFormat((float)(empty($result['net_amount']) ? ($total - $paid_amount) : $result['net_amount'])); ?></td>
                        </tr>
                    </tbody>
                </table>
