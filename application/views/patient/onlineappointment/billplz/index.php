                            ...
                            <form action="<?php echo base_url(); ?>patient/onlineappointment/billplz/pay" method="post">
                                    ...
                                    ?></td></tr>
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td  bgcolor="#fff" class="text-end text-rtl-left"><button type="submit"  name="search"  value="" class="btn btn-info"><?php echo $this->lang->line("pay_with_billplz"); ?> <i class="fa fa fa-chevron-right chevron-rtl-right"></i></button></td>
                                        </tr>
                                    </table>
