                                ...
                                <form id="checkoutform" action="#" method="post">
                                    <table class="table2" width="100%">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td  bgcolor="#fff" class="text-end text-rtl-left"><button type="button"  name="search" id="pay-button" value="" class="btn btn-info"><?php echo $this->lang->line("pay_with_midtrans"); ?> <i class="fa fa-chevron-right chevron-rtl-right"></i></button>  </td>
                                        </tr>
                                    </table>
                                </form>
