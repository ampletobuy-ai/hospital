                            ...
                            <form action="<?php echo base_url(); ?>patient/onlineappointment/sslcommerz/pay" method="post">
                                <table class="table2" width="100%">
                                    ...
                                    <tr class="border_bottom">
                                        ...
                                        <!-- processing fees added -->
											<tr class="border_bottom">
                                                <td><label class="title" for="email"><?php echo $this->lang->line('email'); ?> <small class="req"> *</small></label>
                                                <td><input type="text" class="form-control" name="email" id="email" value="" />
                                                <span class="text-danger"><?php echo form_error('email'); ?></span></td>
                                           </tr>
                                            <tr class="border_bottom">
                                                <td><label class="title" for="pwd"><?php echo $this->lang->line('phone'); ?> <small class="req"> *</small></label>
                                                <td><input type="text" class="form-control" name="phone" value="" />
                                                <span class="text-danger"><?php echo form_error('phone'); ?></span></td>
                                           </tr>
                                            <tr class="border_bottom">
                                                <td><label class="title" for="address"><?php echo $this->lang->line('address'); ?> <small class="req"> *</small></label>
                                ...
                                <?php if (isset($api_error)) { ?>
                                    ...
                                    <tr class="bordertoplightgray">
                                        ...
                                        <td bgcolor="#fff" class="text-end text-rtl-left"><button type="submit"  name="search"  value="" class="btn btn-info"> <?php echo $this->lang->line("pay_with_sslcommerz"); ?> <i class="fa fa-chevron-right chevron-rtl-right"></i></button>  </td>
                                    </tr>
                                </table>
                            </form>
                            </div>
