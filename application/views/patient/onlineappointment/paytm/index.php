                            ...
                            <form action="<?php echo $transactionURL; ?>" method="post">
                                    ...
                                    <tr class="bordertoplightgray">
                                        ...
                                        <tr class="bordertoplightgray">
                                            ...
                                            <td  bgcolor="#fff" class="text-end text-rtl-left"><button type="submit"  name="search"  value="" class="btn btn-info"><?php echo $this->lang->line("pay_with_paytm"); ?> <i class="fa fa-chevron-right chevron-rtl-right"></i></button>  </td>
                                        </tr>
                                    </table>
                                    <?php
