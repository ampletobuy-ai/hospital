...
$balance = (($result->total - $result->discount) + $result->tax) - $result->total_deposit;
$tax_pct  = ($result->total - $result->discount) != 0
    ? ($result->tax * 100) / ($result->total - $result->discount) : 0;
?>
        ...
        <table class="table table-sm table-bordered table-striped mb-0">
            <thead>
                <tr>
                    ...
                    <th><?php echo $this->lang->line('approved_by') . ' / ' . $this->lang->line('approve_date'); ?></th>
            ...
            <tbody>
                <?php $row = 1;
                foreach ($result->pathology_report as $rep) {
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div class="text-muted small"><?php echo html_escape($rep->pathology_center); ?></div>
                    ...
                    <td class="text-center white-space-nowrap">
                        ...
                        <?php if (!empty($rep->pathology_report)) { ?>
                        <a class="btn btn-sm btn-light"
                           href="<?php echo site_url('patient/dashboard/downloadPathologyReport/' . $rep->id); ?>"
