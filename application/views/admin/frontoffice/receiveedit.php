                ...
                <div class="col-md-4">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?php echo $this->lang->line('edit'); ?> <?php echo $this->lang->line('postal_receive'); ?></h3>
                        </div><!-- /.card-header -->
                        <form id="form1"  action="<?php echo site_url('admin/receive/editreceive/' . $receiveData['id']) ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data" >
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input id="date" name="date" placeholder="" type="text" class="form-control date"  value="<?php echo set_value('date', date($this->customlib->getHospitalDateFormat(), $this->customlib->dateyyyymmddTodateformat($receiveData['date']))); ?>" readonly="readonly" />
...
?>">
                ...
                <div class="card">
                    <div class="card-header ptbnull">
                        <h3 class="card-title titlefix"><?php echo $this->lang->line('postal_receive'); ?> <?php echo $this->lang->line('list'); ?></h3>
        ...
        ?>
                                            <tr>
                                                ...
                                                <td class="mailbox-date float-end">
                                                    ...
                                                    <a onclick="getRecord(<?php echo $value->id; ?>)" class="btn btn-secondary btn-sm" data-bs-target="#receviedetails" data-bs-toggle="modal" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing" title="<?= $this->lang->line('view') ?>"><i class="fa fa-reorder"></i></a>
                                                    <?php if ($value->image !== "") {?><a href="<?php echo base_url(); ?>admin/dispatch/download/<?php echo $value->image; ?>" class="btn btn-secondary btn-sm" data-bs-toggle="tooltip" title="" title="<?php echo $this->lang->line('download'); ?>">
                                                            <i class="fa fa-download"></i>
                                                        </a>  <?php }?>   <?php if ($this->rbac->hasPrivilege('postal_receive', 'can_edit')) {?>
                                                        <a href="<?php echo base_url(); ?>admin/receive/editreceive/<?php echo $value->id; ?>" class="btn btn-secondary btn-sm" data-bs-toggle="tooltip" title="" title="<?php echo $this->lang->line('edit'); ?>">
                                                            <i class="fa fa-pencil"></i>
                                                        </a>
                                                    <?php }if ($this->rbac->hasPrivilege('postal_receive', 'can_delete')) {?>

                                                        <?php if ($value->image !== "") {?><a href="<?php echo base_url(); ?>admin/receive/imagedelete/<?php echo $value->id; ?>/<?php echo $value->image; ?>" class="btn btn-secondary btn-sm" data-bs-toggle="tooltip" title="" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');" title="<?= $this->lang->line('delete') ?>">
                                                                <i class="fa fa-remove"></i>
                                                            </a>
                                                        <?php } else {?>
                                                            <a href="<?php echo base_url(); ?>admin/receive/delete/<?php echo $value->id; ?>" class="btn btn-secondary btn-sm" data-bs-toggle="tooltip" title="" onclick="return confirm('<?php echo $this->lang->line('delete_confirm') ?>');" title="<?= $this->lang->line('delete') ?>">
                                                                <i class="fa fa-remove"></i>
                                                            </a>
                                                        <?php }?>
                                                    <?php }?>
