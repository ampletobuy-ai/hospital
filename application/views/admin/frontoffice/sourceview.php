            ...
            <div class="col-md-10">
                ...
                <div class="card">
                    <div class="card-header ptbnull">
                        <h3 class="card-title titlefix"><?php echo $this->lang->line('source_list'); ?></h3>
                                                ...
                                                <td class="text-end">
                                                    <div class="rowoptionview mt-mius0">
                                                        ...
                                                        <?php } if ($this->rbac->hasPrivilege('setup_front_office', 'can_delete')) { ?>
                                                            <a href="javascript:void(0)" class="btn btn-default btn-sm" data-bs-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_source('<?php echo (int)$value['id']; ?>')">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addmultiplerowLabel"><?php echo $this->lang->line('add_source'); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="form_add_multiple" action="<?php echo site_url('admin/source/add_multiple_source') ?>" method="post" accept-charset="utf-8">
                <div class="pup-scroll-area">
                    <div class="modal-body">
                        <div class="sh-form-card">
                            <div class="sh-card-header">
                                <span class="sh-card-header-title"><?php echo $this->lang->line('source'); ?></span>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover mb-0" id="tableID_vitals">
                                    <thead>
                                        <tr>
                                            <th class="sh-w-45p"><?php echo $this->lang->line('source'); ?><small class="req"> *</small></th>
                                            <th><?php echo $this->lang->line('description'); ?></th>
                                            <th class="sh-w-46"></th>
                                        </tr>
                                    </thead>
...
<div class="modal fade sh-modal sh-modal-accent" id="editmyModal" tabindex="-1" aria-labelledby="editmyModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm400 modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editmyModalLabel"><?php echo $this->lang->line('edit_source'); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="editformadd" action="<?php echo site_url('admin/source/edit') ?>" name="employeeform" method="post" accept-charset="utf-8">
                            ...
                            <div class="p-3">
                                <div class="row">
                                    <div class="mb-3 col-12">
                                        <label class="form-label" for="source"><?php echo $this->lang->line('source'); ?></label><small class="req"> *</small>
                                    ...
                                    <div class="mb-0 col-12">
                                        <label class="form-label" for="description1"><?php echo $this->lang->line('description'); ?></label>
