                    ...
                    <form id="form1" action="<?php echo site_url('admin/enquiry/follow_up/' . $id) ?>"   method="post" >
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" id="date" name="date" class="form-control date" value="<?php echo set_value('date'); ?>" readonly="">
                                <span class="text-danger"><?php echo form_error('date'); ?></span>
                            </div>
                            <div class="mb-3">
                                <label for="pwd"><?php echo $this->lang->line('next_follow_up_date'); ?></label>
                                <input type="text" id="date_of_call" name="follow_up_date"class="form-control date" value="<?php echo set_value('follow_up_date'); ?>" readonly="">
                            </div>
                            <div class="mb-3">
