                        ...
                        <h3 class="card-title titlefix"> <?php echo $this->lang->line('postal_receive'); ?> <?php echo $this->lang->line('list'); ?></h3>
                            <div class="d-flex gap-2 align-items-center flex-wrap float-end">
                                    <?php if ($this->rbac->hasPrivilege('postal_receive', 'can_add')) {?>
                                        <a data-bs-toggle="modal" data-bs-target="#myModal" class="btn btn-primary btn-sm receive"><i class="fa fa-plus"></i> <?php echo $this->lang->line('add_receive'); ?> </a>
                                    <?php }?>
...
<div class="modal fade sh-modal sh-modal-accent" id="myModal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('add_receive'); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
                    ...
                    <div class="modal-body modal-background">
                        <div class="sh-form-card">
                            <div class="sh-card-header">
                                <span class="sh-card-header-title"><?php echo $this->lang->line('postal_receive'); ?></span>
                            </div>
                            <div class="p-2">
                                <div class="row g-2">
                                    <div class="col-md-6">
                                        <label class="form-label"><?php echo $this->lang->line('from_title'); ?></label> <small class="req"> *</small>
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label"><?php echo $this->lang->line('to_title'); ?></label>
...
<div class="modal fade sh-modal sh-modal-accent" id="editmyModal" tabindex="-1" aria-labelledby="editmyModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editmyModalLabel"><?php echo $this->lang->line('edit_receive'); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
                        ...
                        <div class="sh-form-card">
                            ...
                            <div class="p-2">
                                <div class="row g-2">
                                    <div class="col-md-6">
                                        <label class="form-label"><?php echo $this->lang->line('from_title'); ?></label> <small class="req"> *</small>
                                        <input type="text" id="from_title" class="form-control form-control-sm" value="<?php echo set_value('from_title'); ?>" name="from_title">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label"><?php echo $this->lang->line('to_title'); ?></label>
                                        <input type="text" id="to_title" class="form-control form-control-sm" value="<?php echo set_value('to_title'); ?>" name="to_title">
                                        <span class="text-danger"><?php echo form_error('to_title'); ?></span>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label"><?php echo $this->lang->line('date'); ?></label>
...
<script type="text/javascript">
 ...
 $("#myModal").on('hidden.bs.modal', function (e) {
    ...
    $(document).ready(function (e) {
        modal_click_disabled('myModal', 'receviedetails', 'editmyModal');
    });
