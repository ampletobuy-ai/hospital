            ...
            <div class="col-md-10">
                ...
                <div class="card" id="exphead">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h3 class="card-title"><?php echo $this->lang->line('symptoms_type_list'); ?></h3>
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive mailbox-messages overflow-visible-lg">
                            <table class="table table-striped table-bordered table-hover example setup-symptoms-type-fixed">
                                <thead>
                                    <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end">
                                                    <div class="rowoptionview mt-mius0">
                                                        <?php if ($this->rbac->hasPrivilege('symptoms_type', 'can_edit')) { ?>
                                                        ...
                                                        <?php } if ($this->rbac->hasPrivilege('symptoms_type', 'can_delete')) { ?>
                                                            <a class="btn btn-default btn-sm" data-bs-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_recordByIdReload('admin/symptoms/deletesymtype/<?php echo $category['id'] ?>', '<?php echo $this->lang->line('delete_confirm'); ?>')">
...
<div class="modal fade sh-modal sh-modal-accent" id="addmultiplerow" tabindex="-1" aria-labelledby="addSymptomsTypeLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addSymptomsTypeLabel"><?php echo $this->lang->line('add_symptoms_type'); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="form_add_multiple" action="<?php echo site_url('admin/symptoms/add_multiple_symadd') ?>" method="post" accept-charset="utf-8">
                <div class="pup-scroll-area">
                    <div class="modal-body">
                        <div class="sh-form-card">
                            <div class="sh-card-header">
                                <span class="sh-card-header-title"><?php echo $this->lang->line('symptoms_type'); ?></span>
                            </div>
                            <div class="table-responsive overflow-visible">
                                <table class="table mb0 tblProducts sh-tbl-transparent" id="tableID_vitals">
                                    <thead>
                                        <tr>
                                            <th><?php echo $this->lang->line('symptoms_type'); ?> <small class="req">*</small></th>
                                            <th class="sh-col-46"></th>
                                        </tr>
                                    </thead>
...
<!-- add multiple data modal -->
<div class="modal fade sh-modal sh-modal-accent" id="editmyModal" tabindex="-1" aria-labelledby="editSymptomsTypeLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm400 modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editSymptomsTypeLabel"><?php echo $this->lang->line('edit_symptoms_type'); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="editformadd" action="<?php echo site_url('admin/symptoms/editsymtype') ?>" name="employeeform" method="post" accept-charset="utf-8">
                            ...
                            <div class="p-3">
                                <div class="row">
                                    <div class="mb-0 col-12">
                                        <label for="symptomstype" class="form-label"><?php echo $this->lang->line('symptoms_type'); ?><small class="req"> *</small></label>
                                        <input id="symptomstype" name="symptoms_type" type="text" class="form-control" />
