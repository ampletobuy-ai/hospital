                ...
                <div class="card" id="exphead">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive mailbox-messages overflow-visible-lg">
                            <table class="table table-striped table-bordered table-hover example setup-incomehead-fixed">
                                <thead>
                                    <tr>
                                                    ...
                                                    <td class="text-end">
                                                        <div class="rowoptionview mt-mius0">
                                                            ...
                                                            <?php } if ($this->rbac->hasPrivilege('income_head', 'can_delete')) { ?>
                                                                <a class="btn btn-default btn-sm" data-bs-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="delete_recordByIdReload('admin/incomehead/delete/<?php echo $category['id'] ?>', '<?php echo $this->lang->line('delete_confirm'); ?>')">
...
<div class="modal fade sh-modal sh-modal-accent" id="addmultiplerow" tabindex="-1" aria-labelledby="addIncomeHeadLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addIncomeHeadLabel"><?php echo $this->lang->line('add_income_head'); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="form_add_multiple" action="<?php echo site_url('admin/incomehead/add_multiple_income_head') ?>" method="post" accept-charset="utf-8">
                <div class="pup-scroll-area">
                    <div class="modal-body">
                        <div class="sh-form-card">
                            <div class="sh-card-header">
                                <span class="sh-card-header-title"><?php echo $this->lang->line('income_head'); ?></span>
                            </div>
                            <div class="table-responsive overflow-visible">
                                <table class="table mb0 tblProducts sh-tbl-transparent" id="tableID_vitals">
                                    <thead>
                                        <tr>
                                            <th><?php echo $this->lang->line('income_head'); ?> <small class="req">*</small></th>
...
<div class="modal fade sh-modal sh-modal-accent" id="editmyModal" tabindex="-1" aria-labelledby="editIncomeHeadLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editIncomeHeadLabel"><?php echo $this->lang->line('edit_income_head'); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="editformadd" action="<?php echo site_url('admin/incomehead/edit') ?>" name="employeeform" method="post" accept-charset="utf-8">
                            ...
                            <div class="p-3">
                                <div class="row">
                                    <div class="mb-3 col-12">
                                        <label for="incomehead1" class="form-label"><?php echo $this->lang->line('income_head'); ?></label><small class="req"> *</small>
                                        <input id="incomehead1" name="incomehead" type="text" class="form-control" value="<?php echo set_value('incomehead'); ?>" />
                                        <span class="text-danger"><?php echo form_error('incomehead'); ?></span>
                                    </div>
                                    <div class="mb-0 col-12">
                                        <label for="description1" class="form-label"><?php echo $this->lang->line('description'); ?></label>
