<div class="row">
    <div class="col-md-12">
        <form id="form1" action="<?php echo base_url() ?>admin/notification/add" name="employeeform" method="post" accept-charset="utf-8">
                ...
                <div class="col-md-8">
                    <div class="card h-100 d-flex flex-column">
                        <div class="card-header">
                            <h3 class="card-title mb-0"><?php echo $this->lang->line('compose_new_message'); ?></h3>
                        </div>
                        <div class="card-body d-flex flex-column flex-grow-1">
                            <div class="mb-3">
                                <label class="form-label form-label-sm"><?php echo $this->lang->line('title'); ?> <small class="req">*</small></label>
                                <input id="title" name="title" type="text" class="form-control form-control-sm" placeholder="<?php echo $this->lang->line('title'); ?>..." value="<?php echo set_value('title'); ?>" />
                            ...
                            <div class="flex-grow-1 d-flex flex-column">
                                ...
                                <textarea id="compose-textarea" name="message" class="form-control flex-grow-1 sh-min-h-260"><?php echo set_value('message'); ?></textarea>
                            ...
                            <div class="row g-2">
                                <div class="col-6">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input id="date" name="date" type="text" class="form-control form-control-sm date" value="<?php echo set_value('date'); ?>" />
                                    </div>
                                ...
                                <div class="col-6">
                                    ...
                                    <div class="input-group input-group-sm">
                                        ...
                                        <input id="publish_date" name="publish_date" type="text" class="form-control form-control-sm date" value="<?php echo set_value('publish_date'); ?>" />
                                    </div>
                        ...
                        <div class="flex-grow-1">
                            ...
                            <label for="role_<?php echo (int)$role_value['id']; ?>"
                                ...
                                <input class="form-check-input flex-shrink-0 mt-0" type="checkbox" name="visible[]"
                                    ...
                                    <?php if ($is_own) { echo 'checked onclick="return false;"'; } ?>
