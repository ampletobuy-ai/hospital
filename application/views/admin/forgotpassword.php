...
<div class="lp-wrap">
  ...
  <div class="lp-form-panel">
    <div class="lp-card">
      ...
      <form action="<?php echo site_url('site/forgotpassword'); ?>" method="post" class="lp-form">
        <?php echo $this->customlib->getCSRF(); ?>

        <div>
          <label class="lp-label" for="af-email"><?php echo $this->lang->line('email'); ?></label>
          <input type="text" id="af-email" name="email" class="lp-input" placeholder="admin@hospital.com" autocomplete="email">
      ...
      <div class="lp-card-alt">
        <a href="<?php echo site_url('site/login'); ?>" class="lp-back-link">
          ...
          <?php echo $this->lang->line('back_to_admin_login') ?: 'Back to Admin sign in'; ?>
        </a>
      </div>
    </div>
  </div>
