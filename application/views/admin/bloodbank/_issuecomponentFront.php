...
<div class="sh-form-card mb-3">
    <div class="sh-card-header">
        <span class="sh-card-header-title"><?php echo $this->lang->line('component_issue_details'); ?></span>
    </div>
    <div class="p-3">
        <div class="row g-2">
            <div class="col-sm-3">
            ...
            <div class="col-sm-3">
                <div class="mb-2">
                    ...
                    <select name="consultant_doctor" id="consultant_doctor" class="form-control form-control-sm select2" <?php if ($disable_option == true) { echo "disabled"; } ?>>
            ...
            <div class="col-sm-3">
                <div class="mb-2">
                    ...
                    <select class="form-control form-control-sm select2 blood_group" name="blood_group" id="component_blood_group">
                        <option value=""><?php echo $this->lang->line('select'); ?></option>
            ...
            <div class="col-sm-3">
                <div class="mb-2">
                    ...
                    <select class="form-control form-control-sm select2 component_issue" id="blood_group_issue_select" disabled readonly>
                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                        <?php foreach ($bloodgroup as $blood_grp_key => $blood_grp_value) { ?>
            ...
            <input type="hidden" name="qty" id="qty_issue">
        </div>
    </div>
</div>
