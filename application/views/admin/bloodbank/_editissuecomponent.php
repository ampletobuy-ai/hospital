        ...
        <div class="row g-2">
            ...
            <div class="col-sm-3">
                <div class="mb-2">
                    ...
                    <select class="form-control form-control-sm select2 component_issue" id="blood_component" name="blood_component">
                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                    </select>
                </div>
            </div>
    ...
    <div class="sh-flex-col">
        <div class="sh-form-card h-100">
            ...
            <div class="px-2 py-3">
                ...
                <div class="mt-2"><?php echo display_custom_fields('component_issue', $result['id']); ?></div>
            </div>
        </div>
    </div>
    <div class="sh-flex-col">
