...
if (!empty($result)) {
    ...
    $total_due    = amountFormat($result['net_amount'] - $result['paid_amount']);
            ...
            <div class="sh-info-grid">
                <div class="row g-0">
                    ...
                    <div class="col-6 col-md-3 sh-info-item">
                        ...
                        <span class="sh-info-value highlight"><?php echo $result['patient_name'] . ' (' . $result['patient_id'] . ')'; ?></span>
                    </div>
                    <div class="col-6 col-md-3 sh-info-item">
                ...
                <div class="row g-0 sh-row-divider">
                    <div class="col-6 col-md-3 sh-info-item">
                        ...
                        <span class="sh-info-value"><?php echo $result['component_name']; ?></span>
                    </div>
                    <div class="col-6 col-md-3 sh-info-item">
                ...
                <div class="row g-0 sh-row-divider">
                    ...
                    <div class="col-12 sh-info-item sh-row-divider">
    ...
    <div class="sh-vd-sum-wrap">
        <div class="sh-form-card h-100 overflow-hidden">
            ...
            <div class="sh-summary-row border-bottom">
                ...
                <span><?php echo $currency_symbol . $result['paid_amount']; ?></span>
            </div>
