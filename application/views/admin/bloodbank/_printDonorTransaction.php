    ...
    <tbody>
        <tr><td>
            ...
            <div class="print-area">
                ...
                <!-- ② Donor / transaction info block -->
                <div class="sh-print-info-block">
                    <div class="sh-flex-gap18">
                        <table class="sh-print-info-table" style="width:55%;">
                            ...
                            <tr>
                                ...
                                <td><?php echo ($this->customlib->getAgeBydob($result['date_of_birth']) ?: '-'); ?></td>
                            </tr>
                            <tr>
                        ...
                        <table class="sh-print-info-table" style="width:45%;">
                            ...
                            <tr>
                                ...
                                <td><?php echo ($transaction->payment_date ? $this->customlib->YYYYMMDDTodateFormat($transaction->payment_date) : '-'); ?></td>
                            </tr>
                        </table>
                    </div>
                </div>
