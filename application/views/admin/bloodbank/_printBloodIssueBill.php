    ...
    <tbody>
        <tr><td>
            ...
            <div class="print-area">
                ...
                <!-- ① Document title -->
                <div class="sh-print-title"><?php echo $this->lang->line('blood_issue'); ?></div>
                    ...
                    <div class="sh-flex-gap18">
                        <table class="sh-print-info-table w-50" >
                            ...
                            <tr>
                                ...
                                <td><?php echo $prefix . ($blood_issues_detail['id'] ?: '-'); ?></td>
                            </tr>
                            <tr>
                ...
                <table class="sh-print-table">
                    ...
                    <tbody>
                        <tr>
                            <td>1</td>
                            <td><?php echo ($blood_issues_detail['charge_category_name'] ?: '-'); ?></td>
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td><?php echo $currency_symbol . amountFormat((float)$blood_issues_detail['total_deposit']); ?></td>
                        </tr>
                        <tr class="sh-row-total">
                            <td colspan="3"><?php echo $this->lang->line('total_due'); ?></td>
                            <td><?php echo $currency_symbol . amountFormat((float)(($blood_issues_detail['amount'] - $discont_amt) + $tax_amt - $blood_issues_detail['total_deposit'])); ?></td>
                        </tr>
                    </tfoot>
                </table>
