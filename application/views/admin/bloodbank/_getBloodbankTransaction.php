...
$has_payment_perm = $this->rbac->hasPrivilege('blood_bank_partial_payment', 'can_add') || $this->rbac->hasPrivilege('blood_bank_billing_payment', 'can_add');
?>
...
<?php
/* Capture patient info card inner HTML to reuse in both layouts */
ob_start(); ?>
        ...
        <div class="sh-info-grid">
            ...
            <div class="row g-0 sh-row-divider">
                <div class="col-6 col-md-3 sh-info-item">
                    ...
                    <span class="sh-info-value"><?php echo html_escape($blood_issue_detail['remark']); ?></span>
                </div>
                <div class="col-6 col-md-3 sh-info-item">
                    <span class="sh-info-label"><?php echo $this->lang->line('tpa'); ?></span>
                    <span class="sh-info-value"><?php echo $blood_issue_detail['organisation_name'] ?: '—'; ?></span>
                </div>
                <div class="col-6 col-md-3 sh-info-item">
                    <span class="sh-info-label"><?php echo $this->lang->line('tpa_id'); ?></span>
                    <span class="sh-info-value"><?php echo isset($blood_issue_detail['insurance_id']) ? $blood_issue_detail['insurance_id'] : '—'; ?></span>
                </div>
                <div class="col-6 col-md-3 sh-info-item">
                    <span class="sh-info-label"><?php echo $this->lang->line('tpa_validity'); ?></span>
                    <span class="sh-info-value"><?php echo isset($blood_issue_detail['insurance_validity']) ? $this->customlib->YYYYMMDDTodateFormat($blood_issue_detail['insurance_validity']) : '—'; ?></span>
                </div>
            </div>
        </div>
...
<?php
/* Capture net amount card inner HTML to reuse in both layouts */
ob_start(); ?>
        <div class="sh-card-header">
        ...
        <div class="sh-summary-netamt">
            ...
            <span><?php echo $currency_symbol . $blood_issue_detail['net_amount']; ?></span>
        </div>
        <div class="sh-summary-row border-bottom">
