                ...
                <div class="card">
                 ...
                 <div class="card-header ptbnull"></div>
                    <div class="card-header">                       
                        <h3 class="card-title"><?php echo $this->lang->line('blood_issue_report'); ?></h3>
                    </div>
                        ...
                        <div class="card-body row pb0">
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control select2 w-100" name="blood_collected_by">
                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                ...
                                <div class="col-sm-6 col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control select2 w-100" name="amount_collected_by">
                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                                            <?php foreach ($staffsearch as $dkey => $value) { ?>
                                                <option value="<?php echo $value["staffid"] ?>"<?php
                                            if ((isset($staffsearch_select)) && ($staffsearch_select == $value["staffid"])) {
        ...
        if(id){
           ...
           $.ajax({
            ...
            success: function (res) {
                ...
                $("#blood_donor").html("<option value=''><?= $this->lang->line('select') ?></option>");
