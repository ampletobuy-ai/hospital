        ...
        <div class="card">
            ...
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="mb-0 fw-semibold sh-fs-95">
                    <?php echo $this->lang->line("edit_payroll_for"); ?> :
                                        ...
                                        if (!empty($earnings)) {
                                            ...
                                            foreach ($earnings as $earning_key => $earning_value) { ?>
                                                ...
                                                <tr id="row<?php echo $earning_count; ?>">
                                                    <td><input type="text" class="form-control" value="<?php echo html_escape($earning_value['allowance_type']); ?>" id="allowance_type" name="allowance_type[]" placeholder="<?php echo $this->lang->line('type'); ?>"></td>
                                                    <td><input type="text" id="allowance_amount" name="allowance_amount[]" class="form-control" value="<?php echo $earning_value['amount']; ?>"></td>
                                                    <td class="sh-col-32"><button type="button" onclick="delete_row(<?php echo $earning_count; ?>)" class="closebtn" autocomplete="off"><i class="fa fa-remove"></i></button></td>
                                                </tr>
                                            <?php $earning_count++;
                                            }
                                        } else { ?>
                                            <tr id="row0">
                                                <td>
                                                    ...
                                                    <input type="text" class="form-control" id="allowance_type" name="allowance_type[]" placeholder="<?php echo $this->lang->line('type'); ?>">
                                                </td>
                                        ...
                                        if (!empty($deductions)) {
                                            ...
                                            foreach ($deductions as $deduction_key => $deduction_value) { ?>
                                                ...
                                                <tr id="deduction_row<?php echo $deduction_count; ?>">
                                                    <td><input type="text" id="deduction_type" name="deduction_type[]" class="form-control" value="<?php echo html_escape($deduction_value['allowance_type']); ?>" placeholder="<?php echo $this->lang->line('type'); ?>"></td>
                                                    <td><input type="text" id="deduction_amount" name="deduction_amount[]" class="form-control" value="<?php echo $deduction_value['amount']; ?>"></td>
                                                    <td class="sh-col-32"><button type="button" onclick="delete_deduction_row(<?php echo $deduction_count; ?>)" class="closebtn" autocomplete="off"><i class="fa fa-remove"></i></button></td>
                                                </tr>
                                            <?php $deduction_count++;
                                            }
                                        } else { ?>
                                            <tr id="deduction_row0">
                                                <td>
                                                    ...
                                                    <input type="text" id="deduction_type" name="deduction_type[]" class="form-control" placeholder="<?php echo $this->lang->line('type'); ?>">
                                                </td>
                                ...
                                <div>
                                    <div class="summary-row">
                                        ...
                                        <div class="summary-value">
                                            <input class="form-control" name="basic" id="basic" type="text" value="<?php echo $employee_payroll['basic']; ?>">
                                        </div>
                                    </div>
                                    <div class="summary-row">
                                    ...
                                    <div class="summary-row is-deduct">
                                        ...
                                        <div class="summary-value">
                                            <input class="form-control" name="total_deduction" id="total_deduction" type="text" value="<?php echo $employee_payroll['total_deduction']; ?>">
                                        </div>
                                    </div>
                                    <div class="summary-row">
