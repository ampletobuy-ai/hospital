                ...
                <div class="card" >
                    ...
                    <form id="form1" action="<?php echo site_url('admin/roles') ?>"  id="employeeform" name="employeeform" method="post" accept-charset="utf-8">
                        ...
                        <div class="card-footer">
                            <button type="submit" class="btn btn-info float-end"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
                        </div>
                    </form>
                </div>
            </div>         
                                    ...
                                    <?php if (empty($listroute)) {
                                        ...
                                        foreach ($listroute as $data) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-end text-nowrap noExport">
                                                    <?php
