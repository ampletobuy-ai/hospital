                ...
                <?php $this->load->view('admin/report/_ipd');?>
                  <div class="card-header ptbnull"></div>
                    <div class="card-header">
                        <h3 class="card-title"><?php echo $this->lang->line('ipd_discharged_patient_report'); ?></h3>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control select2 w-100" name="doctor">
                                        <option value=""><?php echo $this->lang->line('select') ?></option>
                            ...
                            <div class="col-sm-6 col-md-3" >
                                <div class="mb-3">
                                    <label><?php echo $this->lang->line('discharge_status'); ?></label>
                                     <select class="form-control w-100" name="discharged">
                                       <option value=""><?php echo $this->lang->line('select') ?></option>
                            ...
                            <table class="table table-striped table-bordered table-hover allajaxlist" cellspacing="0" width="100%" data-export-title="<?php echo $this->lang->line('ipd_discharged_patient_report'); ?>">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-end"><?php echo $this->lang->line('total_admit_days'); ?></th> 
                                    </tr>
                                </thead>
                                <tbody>
                                </tbody>
