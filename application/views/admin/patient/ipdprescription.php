...
<div class="sh-form-card m-2">
    <div class="sh-card-header">
        <span class="sh-card-header-title"><i class="fa fa-file-text me-1"></i> <?php echo $this->lang->line('prescription'); ?> <strong class="ms-1"><?php echo html_escape($this->customlib->getSessionPrefixByType('ipd_prescription') . $result->prescription_id); ?></strong></span>
    ...
    <div class="sh-info-grid">
        ...
        <div class="row g-0 sh-row-divider">
            ...
            <div class="col-6 col-md-4 sh-info-item">
                ...
                <span class="sh-info-value"><?php echo html_escape($result->priscribe_by_name . ' ' . $result->priscribe_by_surname); ?> <span class="text-muted fw-normal">(<?php echo html_escape($result->priscribe_by_employee_id); ?>)</span></span>
            </div>
        </div>
        <div class="row g-0 sh-row-divider">
            <div class="col-12 <?php echo ($result->attachment != '') ? 'col-md-6' : ''; ?> sh-info-item">
                ...
                <span class="sh-info-value"><?php echo html_escape($result->staff_name . ' ' . $result->staff_surname); ?> <span class="text-muted fw-normal">(<?php echo html_escape($result->staff_employee_id); ?>)</span></span>
            </div>
            ...
            <div class="col-12 col-md-6 sh-info-item">
                ...
                <span class="sh-info-value">
                    <a href="<?php echo site_url('admin/prescription/downloadprescription/' . $result->prescription_id); ?>" class="btn btn-sm btn-light" data-bs-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>"><i class="fa fa-download me-1"></i><?php echo $this->lang->line('download'); ?></a>
                </span>
            </div>
            <?php } ?>
        </div>
