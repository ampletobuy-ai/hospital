                ...
                <div class="p-2">
                    <div class="row mt5">
                        <div class="col-sm-3 col-3">
                            ...
                            <input name="bleeding" id="bleeding" type="text" class="form-control form-control-sm" />
                        </div>
                        <div class="col-sm-3 col-3">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('headache'); ?></label>
                            <input name="headache" id="headache" type="text" class="form-control form-control-sm" />
                        </div>
                        <div class="col-sm-3 col-3">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('pain'); ?></label>
                            <input name="pain" id="pain" type="text" class="form-control form-control-sm" />
                        </div>
                        <div class="col-sm-3 col-3">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('constipation'); ?></label>
                            <input name="constipation" id="constipation" type="text" class="form-control form-control-sm" />
                        </div>
                        <div class="col-sm-3 col-3">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('vomiting'); ?></label>
                            <input name="vomiting" id="vomiting" type="text" class="form-control form-control-sm" />
                        </div>
                        <div class="col-sm-3 col-3">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('cough'); ?></label>
                            <input name="cough" id="cough" type="text" class="form-control form-control-sm" />
                        </div>
                        <div class="col-sm-3 col-3">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('haemoroids'); ?></label>
                            <input name="haemoroids" id="haemoroids" type="text" class="form-control form-control-sm" />
                        </div>
                        <div class="col-sm-3 col-3">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('discharge'); ?></label>
                            <input name="discharge" id="discharge" type="text" class="form-control form-control-sm" />
                        </div>
                        <div class="col-sm-3 col-3">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('oedema'); ?></label>
                            <input name="oedema" id="oedema" type="text" class="form-control form-control-sm" />
                        </div>
                        <div class="col-sm-3 col-3">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('urinary_symptoms'); ?></label>
                            <input name="urinary_symptoms" id="urinary_symptoms" type="text" class="form-control form-control-sm" />
                        </div>
                        <div class="col-sm-3 col-3">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('vaginal'); ?></label>
                            <input name="vaginal" id="vaginal" type="text" class="form-control form-control-sm" />
                        </div>
                        <div class="col-sm-3 col-3">
                        ...
                        <div class="col-sm-3 col-3">
                            ...
                            <input name="antenatal_date" id="antenatal_date" type="text" class="form-control form-control-sm datetime" />
                        </div>
                    </div>
                    <div class="row mt5">
                        <div class="col-md-6 col-12">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('condition'); ?></label>
                            <textarea name="condition" id="condition" rows="2" class="form-control form-control-sm"><?php echo set_value('note'); ?></textarea>
                        </div>
                        <div class="col-md-6 col-12">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('special_findings_and_remark'); ?></label>
                            <textarea name="special_finding_remarks" id="special_finding_remarks" rows="2" class="form-control form-control-sm"><?php echo set_value('address'); ?></textarea>
                        </div>
                        <div class="col-md-6 col-12">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('pelvic_examination'); ?></label>
                            <textarea name="pelvic_examination" id="pelvic_examination" rows="2" class="form-control form-control-sm"><?php echo set_value('address'); ?></textarea>
                        </div>
                        <div class="col-md-6 col-12">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('sp'); ?></label>
                            <textarea name="sp" id="sp" rows="2" class="form-control form-control-sm"><?php echo set_value('address'); ?></textarea>
                        </div>
                    </div>
                    <div class="row mt5">
                ...
                <div class="p-2">
                    <div class="row mt5">
                        <div class="col-sm-6">
                            ...
                            <input name="uter_size" id="uter_size" type="text" class="form-control form-control-sm" />
                        ...
                        <div class="col-sm-6">
                            ...
                            <input name="uterus_size" id="uterus_size" type="text" class="form-control form-control-sm" />
                        ...
                        <div class="col-sm-6">
                            ...
                            <input name="presentation_position" id="presentation_position" type="text" class="form-control form-control-sm" />
                            <span class="text-danger"><?php echo form_error('case'); ?></span>
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('presenting_part_to_brim'); ?></label>
                            <input name="presentation_brim" id="presentation_brim" type="text" class="form-control form-control-sm" />
                            <span class="text-danger"><?php echo form_error('case'); ?></span>
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('foeta_heart'); ?></label>
                            <input name="foeta_heart" id="foeta_heart" type="text" class="form-control form-control-sm" />
                            <span class="text-danger"><?php echo form_error('refference'); ?></span>
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('blood_pressure'); ?></label>
                            <input name="blood_pressure" id="blood_pressure" type="text" class="form-control form-control-sm" />
                            <span class="text-danger"><?php echo form_error('refference'); ?></span>
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('antenatal_oedema'); ?></label>
                            <input name="antenatal_oedema" type="text" class="form-control form-control-sm" />
                            <span class="text-danger"><?php echo form_error('refference'); ?></span>
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('antenatal_weight'); ?></label>
                            <input name="antenatal_weight" type="text" class="form-control form-control-sm" />
                        </div>
                        <div class="col-sm-6">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('urine_sugar'); ?></label>
                            <input name="urine" type="text" class="form-control form-control-sm" />
                        ...
                        <div class="col-sm-6">
                            ...
                            <input name="urine_aaibumen" type="text" class="form-control form-control-sm" />
                            <span class="text-danger"><?php echo form_error('apply_charge'); ?></span>
                        </div>
                        <div class="col-12">
                            <label class="form-label mb-1 small fw-medium"><?php echo $this->lang->line('remark'); ?></label>
                            <textarea name="remark" id="remark" rows="2" class="form-control form-control-sm"><?php echo set_value('remark'); ?></textarea>
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="next_visit" id="next_visit" rows="2" class="form-control form-control-sm"><?php echo set_value('remark'); ?></textarea>
                            <span class="text-danger"><?php echo form_error('standard_charge'); ?></span>
                        </div>
                    </div>
                </div>
