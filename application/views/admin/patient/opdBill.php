                ...
                <div>
                    <div class="pprinta4" >
                        <?php if (!empty($print_details[0]['print_header'])) { ?>
                            <img style="height:100px ; width:100%;" class="img-fluid" src="<?php echo $this->media_storage->getImageURL($print_details[0]["print_header"]) ?>">
                        <?php } ?>
                        <div class="sh-spacer-10"></div>
                    </div>
                    <table width="100%" class="printablea4">
                        <tr>
                            <td class="text-start"><?php echo $this->lang->line('bill') . " #" ?><?php echo $this->customlib->getSessionPrefixByType('opd_billing').$result["opdid"] ?></td>
                            <td class="text-end"><?php echo $this->lang->line('date') . " : " ?><?php
                    ...
                    <table class="printablea4" cellspacing="0" width="100%">
                        ...
                        <tr>
                            ...
                            <td class="text-start"><?php echo $result['organisation_name']; ?></td> 
                        </tr> 
                        <tr>
                        </tr> 
                    </table>
                    ...
                    <table class="printablea4" width="100%">
                        ...
                        <tr>
                            ...
                            <td></td>
                            <td></td>
                            <td class="text-end"><?php echo $this->lang->line('total') . " : " ?>  <?php echo $currency_symbol . number_format( $total, 2) ?></td>
                        </tr>
                    </table>
                    <div class="divider mt-10 mb-10"></div>
                    <table class="printablea4" width="100%">
                        ...
                        foreach ($payment_details as $key => $payment) {
                            ...
                            <tr>
                                ...
                                <td width="50%" class="text-end"><?php echo number_format($payment["paid_amount"] , 2) ; ?></td>
                            </tr>
                            <?php
                        ...
                        <tr>
                            <td width="25%"></td>
                            <td width="25%"></td>
                            <td width="50%" class="text-end"><?php echo $this->lang->line('total') . " : " ?> <?php echo $currency_symbol . number_format($total_paid , 2)?></td>
                        </tr>
                    </table>
                    <div class="divider mt-10 mb-10"></div> 
                    <table class="printablea4" width="100%">
                        ...
                        <tr>
                            <th width="20%"><?php echo $this->lang->line('total_payment') . " (" . $currency_symbol . ")" ?> </th> 
                            <td class="text-end" width=""><?php
                        ...
                        <tr>
                         <tr>
                            ...
                            <td class="text-end"><?php echo $result['bill_paymode']; ?> </td>
                        </tr>
                        <tr>
                            <td colspan="2">
                              <div class="divider mt-10 mb-10"></div>
