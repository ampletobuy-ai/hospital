...
<div class="row">
    ...
    <div class="col-lg-9 border-end opd-rx-left">
        ...
        <div class="sh-form-card mb-3">
            ...
            <div class="p-2">
                <textarea name="header_note" class="form-control opd-note-area" id="compose-textareanewadd"></textarea>
            </div>
        </div>
            ...
            <div class="p-2 sh-overflow-visible" >
                <div class="row g-3 align-items-start">
                    ...
                    <div class="col-md-3 position-relative" >
                        <label class="form-label mb-1" for="filterinput"><?php echo $this->lang->line('findings'); ?></label>
                    ...
                    <div class="col-md-2">
                        ...
                        <div class="form-check mt-2">
                            <input class="form-check-input" type="checkbox" id="finding_print_chk" name="finding_print" value="yes" checked>
                            <label class="form-check-label" for="finding_print_chk"><?php echo $this->lang->line('yes'); ?></label>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered mb-0 align-middle">
                        <thead class="table-light">
                            <tr>
                                <th class="sh-mw-min-160"><i class="fa fa-medkit me-1 text-muted"></i><?php echo $this->lang->line('medicine'); ?> <small class="text-danger">*</small></th>
                        ...
                        <tbody id="tableID">
                            <tr id="row1">
                                <td>
                                    ...
                                    <select data-rowid="1" class="form-control select2 medicine_name w-100"  name="medicine_1">
                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                        <?php foreach ($medicineName as $mkey => $mvalue) { ?>
                                            <option value="<?php echo $mvalue["id"]; ?>"><?php echo $mvalue["medicine_name"]; ?></option>
                                        <?php } ?>
                                    </select>
                                    <small id="stock_info_1" class="text-muted"></small>
                                ...
                                <td>
                                    <select class="form-control select2 w-100"  name='interval_dosage_1'>
                                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                                ...
                                <td>
                                    <textarea name="instruction_1" rows="1" class="form-control"></textarea>
                                </td>
                                <td class="text-center">
                                    <button type="button" class="btn btn-sm btn-outline-danger closebtn delete_row_prescription" data-row-id="1"><i class="fa fa-remove"></i></button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <div class="sh-form-card mb-3">
            ...
            <div class="p-2">
                <textarea name="footer_note" rows="1" class="form-control opd-note-area" id="compose-textareasadd"></textarea>
            </div>
        </div>
            ...
            <div class="p-2">
                <select class="form-control select2 w-100"  name='prescribe_by'>
                    ...
                    <?php foreach ($priscribe_list as $key => $value) { ?>
                        <option value="<?php echo $value["consult_doctor"]; ?>"><?php echo $value['ipd_doctorname'] . " " . $value['ipd_doctorsurname'] . "(" . $value['employee_id'] . ")"; ?></option>
                    <?php } ?>
                </select>
            </div>
        </div>
            ...
            <div class="p-2">
                ...
                foreach ($roles as $role_key => $role_value) {
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="visible[]" id="visible_<?php echo $role_value['id']; ?>" value="<?php echo $role_value['id']; ?>" <?php if ($role_value["id"] == $role_id) { echo "checked onclick='return false;'"; } ?> <?php echo set_checkbox('visible[]', $role_value['id'], false) ?> />
                        <label class="form-check-label" for="visible_<?php echo $role_value['id']; ?>"><?php echo $role_value['name']; ?></label>
                    </div>
                <?php } ?>
            </div>
        </div>
