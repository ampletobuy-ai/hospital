...
$total_due      = $result['net_amount'] - $result['total_deposit'];
        ...
        <div class="sh-form-card h-100">
            ...
            <div class="sh-info-grid">
                ...
                <div class="row g-0 sh-row-divider">
                    <div class="col-6 col-md-3 sh-info-item">
                        <div class="sh-info-label"><?php echo $this->lang->line('donor_name'); ?></div>
                        <div class="sh-info-value"><?php echo $result['donor_name'] ?: '—'; ?></div>
                    </div>
                    <div class="col-6 col-md-3 sh-info-item">
                    ...
                    <div class="col-6 col-md-3 sh-info-item">
                        <div class="sh-info-label"><?php echo $this->lang->line('reference'); ?></div>
                        <div class="sh-info-value"><?php echo $result['reference'] ?: '—'; ?></div>
                    </div>
                </div>
    ...
    <div class="sh-vd-sum-wrap">
        <div class="sh-form-card h-100 overflow-hidden">
            ...
            <div class="sh-summary-row">
                ...
                <span class="text-success fw-semibold"><?php echo $currency_symbol . amountFormat($result['total_deposit']); ?></span>
            </div>
