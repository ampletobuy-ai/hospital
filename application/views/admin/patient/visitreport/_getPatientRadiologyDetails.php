...
<div class="sh-form-card">
    <div class="sh-card-header">
        <span class="sh-card-header-title"><i class="fa fa-television me-1 opacity-75"></i><?php echo $this->lang->line('radiology_test'); ?></span>
    </div>
    <div class="p-2">
            ...
            <table class="table table-sm table-hover mb-0">
                <thead>
                    <tr>
                        ...
                        <th><?php echo $this->lang->line('approved_by'); ?> / <?php echo $this->lang->line('update_date'); ?></th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <small class="text-muted d-block"><?php echo $this->lang->line('radiology'); ?>: <?php echo $rv->radiology_center; ?></small>
