...
<div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <h3 class="card-title titlefix"> <?php echo $this->lang->line('patient_login_credential'); ?></h3>
                    </div><!-- /.card-header -->
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-3 col-sm-6 col-md-3">
                                    <div class="mb-3 position-relative">
                                        ...
                                        <span class="text-danger position-absolute top-100 start-0" id="error_search_type"><?php echo form_error('search_type'); ?></span>
                                    </div>
                                </div>                                
                                <div class="col-lg-3 col-sm-6 col-md-3 d-none" id="fromdate">
                                    <div class="mb-3">
                                ...
                                <div class="col-lg-3 col-sm-6 col-md-3 d-none" id="todate">
                                    <div class="mb-3">
