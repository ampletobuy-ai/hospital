            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title titlefix"><?php echo $this->lang->line('patient'); ?></h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12 pt20">
                                    <button type="submit" class="btn btn-info float-end"><i class="fa fa-upload"></i> <?php echo $this->lang->line('import'); ?></button>
                                </div>
                            </div>
                        </div>
                    </form>
