            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title titlefix"> <?php echo $this->lang->line('ipd') . " " . $this->lang->line('patient'); ?></h3>                     
                        <div class="d-flex gap-2 align-items-center flex-wrap float-end">
                            <?php if ($this->rbac->hasPrivilege('ipd_patient', 'can_add')) { ?>                 
                                <a data-bs-toggle="modal" onclick="holdModal('myModal')" id="addp" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('add') . " " . $this->lang->line('patient') ?></a> 
                            <?php } ?>
                            ...
                            <table class="table table-striped table-bordered table-hover example" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-end"><?php echo $this->lang->line('due') . " " . $this->lang->line('payment') . " (" . $currency_symbol . ")"; ?></th>
                                    ...
                                    if (empty($resultlist)) {
                                        ...
                                        foreach ($resultlist as $patient) {
                                            ...
                                            <tr class="<?php echo $class; ?>">
                                                <td>
                                                    ...
                                                    <div class="rowoptionview">       
                                                        <?php if ($this->rbac->hasPrivilege('consultant_register', 'can_add')) { ?>
                                                            <a href="#" onclick="add_instruction('<?php echo $patient['id'] ?>')" class="btn btn-secondary btn-sm"  data-bs-toggle="tooltip" title="<?php echo $this->lang->line('consultant') . " " . $this->lang->line('instruction'); ?>" >
                                                                <i class="fa fa-user-md"></i>
                                                            </a>                                     
                                                        <?php } ?>
                                                        <?php if ($this->rbac->hasPrivilege('ipd_patient', 'can_view')) { ?>
                                                            <a href="<?php echo base_url(); ?>admin/patient/ipdprofile/<?php echo $patient['id'] ?>/<?php echo $patient['ipdid']; ?>" class="btn btn-secondary btn-sm"  data-bs-toggle="tooltip" title="<?php echo $this->lang->line('show'); ?>" >
                                                ...
                                                <td class="text-end"><?php echo number_format($patient["charges"], 2, '.', '');?> </td>
                                                <td class="text-end"><?php echo $patient['payment'] ?></td>
                                                <td class="text-end"><?php echo $patient['charges'] - $patient['payment'] ?></td>
                                                <td class="text-end"><?php echo $patient['credit_limit'] ?></td>
                                            </tr>
                                            <?php
                                            $count++;
                                        }
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="myModalLabel"><?php echo $this->lang->line('add') . " " . $this->lang->line('patient'); ?></h5>
                        ...
                        <div class="col-sm-4 col-5">
                            <div class="form-group15">
                                <?php if ($this->rbac->hasPrivilege('patient', 'can_add')) { ?>
                                    <a data-bs-toggle="modal" id="addpip" onclick="holdModal('myModalpa')" class="modalbtnpatient"><i class="fa fa-plus"></i>  <?php echo $this->lang->line('new') . " " . $this->lang->line('patient') ?></a>
                                <?php } ?>
                            </div>
                        </div>
                    </div><!--./row-->
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <div>
                                                ...
                                                ?> class="w-100" id='consultant_doctor' name='consultant_doctor'>
                                                    <option value=""><?php echo $this->lang->line('select') ?></option>
...
<?php } ?>
                                    ...
                                    <div class="col-sm-12">
                                        <div class="mb-3">
                                            ...
                                            <div><select class="form-control select2 w-100"  name='bed_no' id='bed_no'>
                                                    <option value=""><?php echo $this->lang->line('select') ?></option>
                                                </select>
                                            </div>
...
?>
                                ...
                                <div class="col-sm-3">
                                    <div class="mb-3">
                                        ...
                                        <div class="sh-clear">
                                            <input type="text" placeholder="<?php echo $this->lang->line('year') ?>" name="age" id="age" class="form-control" value="<?php echo set_value('age'); ?>" class="sh-print-left-40">
                                            <input type="text" placeholder="<?= $this->lang->line('month') ?>" name="month"  id="month"value="<?php echo set_value('month'); ?>" class="form-control sh-print-left-56" >
                                        </div>
                                    </div>
                                </div>                                   
                                <div class="col-sm-3">
...
<div class="modal fade sh-modal sh-modal-accent" id="add_instruction" tabindex="-1" aria-labelledby="add_instructionLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="add_instructionLabel"><?php echo $this->lang->line('consultant') . " " . $this->lang->line('instruction'); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <table class="table table-striped table-bordered table-hover" id="tableID">
                                    <tr>
                                        <th><?php echo $this->lang->line('applied_date'); ?><small class="req red sh-text-danger" > *</small></th>
                                        <th><?php echo $this->lang->line('consultant'); ?><small class="req red sh-text-danger" > *</small></th>
                                        <th><?php echo $this->lang->line('instruction'); ?>
                                            <small class="req red sh-text-danger" > *</small>
                                        </th>
...
<?php } ?>
                                        ...
                                        <td><button type="button" onclick="add_more()" style="color:var(--blue)" class="closebtn"><i class="fa fa-plus"></i></button></td>
                                    </tr>
                                </table>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary" data-bs-dismiss="modal"><?php echo $this->lang->line('cancel'); ?></button>
                    <button type="submit" id="consultant_registerbtn" data-loading-text="<?php echo $this->lang->line('processing') ?>" class="btn btn-info"><?php echo $this->lang->line('save'); ?></button>
                </div>
            </form>
        </div>
    </div>
