   ...
   <div class="col-md-10">
    <div class="card" id="tachelist">
     <div class="card-header ptbnull">
      <h3 class="card-title titlefix"><?php echo $this->lang->line('company_list') ;?></h3>
         ...
         <tr>
          ...
          <td class="text-end">
            <div class="rowoptionview mt-mius0">
             ...
             <a href="javascript:void(0)" onclick="editmyModal(this)" data-id="<?php echo $value['id'] ?>" data-company_name="<?php echo htmlspecialchars($value['company_name'], ENT_QUOTES); ?>" class="btn btn-default btn-sm" data-bs-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addmultiplerowLabel"><?php echo $this->lang->line('add_company') ;?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form id="form_add_multiple" action="<?php echo site_url('admin/medicineunit/add_multiple_company') ?>" method="post" accept-charset="utf-8">
                <div class="pup-scroll-area">
                    <div class="modal-body">
                        <div class="sh-form-card">
                            <div class="sh-card-header">
                                <span class="sh-card-header-title"><?php echo $this->lang->line('add_company') ?></span>
                            </div>
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover mb-0" id="tableID_vitals">
                                    <thead>
                                        <tr>
                                            <th><?php echo $this->lang->line('company_name'); ?><small class="req"> *</small></th>
                                            <th class="sh-w-46"></th>
                                        </tr>
                                    </thead>
...
<div class="modal fade sh-modal sh-modal-accent" id="myModal" tabindex="-1" aria-labelledby="company_title" aria-hidden="true">
    <div class="modal-dialog modal-sm400 modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="company_title"><?php echo $this->lang->line('add_company'); ?></h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
                            ...
                            <div class="p-3">
                                <div class="row">
                                    <div class="mb-0 col-12">
                                        <label class="form-label"><?php echo $this->lang->line('company_name'); ?></label><small class="req"> *</small>
...
<script>
    ...
    function editmyModal(el){
        var id           = $(el).data('id');
        var company_name = $(el).data('company_name');
