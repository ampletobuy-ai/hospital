    ...
    <tbody>
        <tr><td>
            ...
            <div class="print-area">
                ...
                <!-- ① Document title: payment or refund -->
                <?php $payment_type = ($transaction->type == 'refund') ? $this->lang->line('payment_refund') : $this->lang->line('payment_received'); ?>
                <div class="sh-print-title"><?php echo $payment_type; ?></div>
                ...
                <!-- Note as text block (Rule #15 — not inside tfoot) -->
                <?php if (!empty($transaction->note)) { ?>
                <div class="sh-note-block">
                    <span class="fw-semibold"><?php echo $this->lang->line('note'); ?>: </span><?php echo html_escape($transaction->note); ?>
                </div>
                <?php } ?>
