                ...
                <?php $this->load->view('admin/report/_pharmacy');?>
                 <div class="card-header ptbnull"></div>
                    <div class="card-header">                        
                        <h3 class="card-title"><?php echo $this->lang->line('pharmacy_bill_report'); ?></h3>
                    </div>
                    <form id="form1" action="" method="post" class="">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control w-100" name="doctor_name">
                                    <option value=""><?php echo $this->lang->line('select') ?></option>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="mb-3">
                                    <label><?php echo $this->lang->line('payment_mode'); ?>
                                        <i class="fa fa-info-circle text-primary ms-1" role="button" tabindex="0"
                                           data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-placement="top"
                                           data-bs-content="<?php echo html_escape($this->lang->line('payment_mode_note')); ?>"></i>
                                    </label>
            ...
            <div class="modal-body min-h-3">
                <div class="modalicon">
                    <div id='edit_deletebill'>
                        <a href="#"  data-bs-target="#edit_prescription" data-placement="bottom" data-bs-toggle="modal" title="" title="<?php echo $this->lang->line('edit'); ?>"><i class="fa fa-pencil"></i></a>
                        <a href="#" data-bs-toggle="tooltip" data-placement="bottom" title="" title="<?php echo $this->lang->line('delete'); ?>"><i class="fa fa-trash"></i></a>
                    </div>
                </div>
