...
<div class="row">
            <div class="col-md-12">
                ...
                <?php $this->load->view('admin/report/_ot');?>  
                 <div class="card-header ptbnull"></div>
                    <div class="card-header">                        
                        <h3 class="card-title"><?php echo $this->lang->line('ot_report'); ?></h3>
                    </div>
                        ...
                        <div class="card-body row pb-0">
                            ...
                            <div class="col-sm-6 col-md-3">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control select2 w-100" name="consultant_doctor">
                                    <option value=""><?php echo $this->lang->line('select'); ?></option>
                ...
                <div class="mb-3">
                  ...
                  <select name="operation_category" id="operation_category" class="form-control select2 w-100">
                            <option value=""><?php echo $this->lang->line('select') ?></option>
             ...
             <div class="col-sm-6 col-md-3">
                    <div class="mb-3">
                       ...
                       <div>
                        <select name="operation_name" id="operation_name" class="form-control w-100">
                            <option value=""><?php echo $this->lang->line('select') ?></option>
                        </select>
                    </div>
                        <span class="text-danger"><?php echo form_error('operation_name'); ?></span>
                            ...
                            <div class="mb-3">
                                <div class="col-sm-12">
                                    <button type="submit" name="search" value="search_filter" class="btn btn-primary d-inline-flex align-items-center gap-1 py-2 checkbox-toggle float-end">
                            ...
                            <table class="table table-striped table-bordered table-hover allajaxlist" data-export-title="<?php echo $this->lang->line('ot_report'); ?>">
                                <thead>
                                    <tr>
                                        ...
                                        <?php } } ?>
                                        <th class="text-end"><?php echo $this->lang->line('result'); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                 </tbody>
