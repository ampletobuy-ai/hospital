			...
			<div class="col-md-12">            
                ...
                <div class="card-header ptbnull"></div>
                    <div class="card-header">
                        <h3 class="card-title titlefix"><?php echo $this->lang->line('user_log'); ?></h3>
                            ...
                            <table class="table table-striped table-bordered table-hover allajaxlist"data-export-title="<?php echo $this->lang->line('user_log'); ?>">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-end"><?php echo $this->lang->line('user_agent'); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                ...
                if (data.status == "fail") {
                   $.each(data.error, function(key, value) {
                    ...
                    initDatatable('allajaxlist', 'admin/userlog/userlogreports/',data.param,[],100,[
                        ...
                        { "bSortable": false, "aTargets": [ -1 ], 'sClass': 'dt-body-right', 'sWidth': '400px' }
                    ]);
                }
            }
        });
