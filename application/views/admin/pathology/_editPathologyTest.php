        ...
        <div class="row g-2">
            ...
            <div class="col-sm-3">
                <div class="mb-3">
                    ...
                    <input type="text" name="method" class="form-control form-control-sm" value="<?php echo set_value('method', $result->method); ?>">
                </div>
            </div>
            <div class="col-sm-3">
                <div class="mb-3">
            ...
            <div class="col-sm-3">
                <div class="mb-3">
                    ...
                    <input class="form-control form-control-sm" name="tax" id="tax" value="<?php echo set_value('tax', $result->tax); ?>" readonly>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="mb-3">
            ...
            <div class="col-sm-3">
                <div class="mb-3">
                    ...
                    <input readonly value="<?php echo set_value('amount', amountFormat($result->standard_charge + calculatePercent($result->standard_charge, $result->tax))); ?>" class="form-control form-control-sm" name="amount" id="amount">
                ...
                <tbody>
                    ...
                    <tr id="row<?php echo $row_count; ?>">
                        <td width="35%">
                            ...
                            <select class="form-control form-control-sm select2 pathology_parmeter w-100" id="parameter_name_<?php echo $row_count; ?>" name="parameter_name_<?php echo $row_count; ?>">
