...
<div class="sh-form-card mb-3">
    ...
    <div class="sh-info-grid">
        ...
        <div class="row g-0 sh-row-divider">
            ...
            <div class="col-6 col-md-3 sh-info-item">
                <span class="sh-info-label"><?php echo $this->lang->line('method'); ?></span>
                <span class="sh-info-value"><?php echo $result->method ?: '—'; ?></span>
            </div>
            <div class="col-6 col-md-3 sh-info-item">
                <span class="sh-info-label"><?php echo $this->lang->line('category_name'); ?></span>
                <span class="sh-info-value"><?php echo $result->pathology_category_name ?: '—'; ?></span>
            </div>
            <div class="col-6 col-md-3 sh-info-item">
                <span class="sh-info-label"><?php echo $this->lang->line('charge_name'); ?></span>
                <span class="sh-info-value"><?php echo $result->charge_name ?: '—'; ?></span>
            </div>
        </div>
        <div class="row g-0 sh-row-divider">
            <div class="col-6 col-md-3 sh-info-item">
            ...
            <div class="col-6 col-md-3 sh-info-item">
                ...
                <span class="sh-info-value"><?php echo $result->tax; ?>%</span>
            </div>
            <div class="col-6 col-md-3 sh-info-item">
        ...
        <div class="row g-0 sh-row-divider">
            <div class="col-6 col-md-3 sh-info-item">
                ...
                <span class="sh-info-value"><?php echo $currency_symbol . amountFormat($result->standard_charge + calculatePercent($result->standard_charge, $result->tax)); ?></span>
            </div>
            <?php if (!empty($result->description)) { ?>
            <div class="col-6 col-md-9 sh-info-item">
                <span class="sh-info-label"><?php echo $this->lang->line('charge_description'); ?></span>
                <span class="sh-info-value"><?php echo $result->description; ?></span>
            </div>
            <?php } ?>
        </div>
        <?php
    ...
    <div class="p-2">
        <div class="table-responsive">
            <table class="table table-sm table-hover sh-tests-table mb-0">
                ...
                <tbody>
                    <?php foreach ($result->pathology_parameter as $pathology_value) { ?>
                    <tr>
