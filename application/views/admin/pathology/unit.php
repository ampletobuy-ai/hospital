                ...
                <div class="card" id="tachelist">
                    ...
                    <div class="card-body">
                        ...
                        <div class="table-responsive mailbox-messages overflow-visible">
                            ...
                            <table class="table table-striped table-bordered table-hover example setup-patho-unit-fixed" >
                                <thead>
                                    <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <div class="rowoptionview mt-mius0">
                                                    ...
                                                    <?php } if ($this->rbac->hasPrivilege('pathology_unit', 'can_delete')) { ?>
                                                        <a href="<?php echo base_url(); ?>admin/pathologycategory/deleteunit/<?php echo $lab['id'] ?>" class="btn btn-default btn-sm" data-bs-toggle="tooltip" title="<?php echo $this->lang->line('delete'); ?>" onclick="return confirm('<?php echo $this->lang->line('delete_confirm'); ?>');">
...
<div class="modal fade sh-modal sh-modal-accent" id="myModal" tabindex="-1" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm400 modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="formadd" action="<?php echo site_url('admin/pathologycategory/addunit') ?>" name="employeeform" method="post" accept-charset="utf-8">
...
<div class="modal fade sh-modal sh-modal-accent" id="editmyModal" tabindex="-1" aria-labelledby="editmyModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm400 modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="editformadd" action="<?php echo site_url('admin/pathologycategory/addunit') ?>" name="employeeform" method="post" accept-charset="utf-8">
