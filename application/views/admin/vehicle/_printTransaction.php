    ...
    <tbody>
        <tr><td>
            ...
            <div class="print-area">
                ...
                <?php if (!empty($transaction->staff_name)) { ?>
                <div class="sh-summary-note">
                    <span class="fw-semibold"><?php echo $this->lang->line('received_by'); ?>: </span>
                    <?php echo html_escape(composeStaffNameByString($transaction->staff_name, $transaction->staff_surname, $transaction->employee_id)); ?>
                </div>
                <?php } ?>
