            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header ptbnull">
                        <h3 class="card-title titlefix"><?php echo $this->lang->line('approve_leave_request'); ?></h3>
                        <?php
                        if ($this->rbac->hasPrivilege('approve_leave_request', 'can_add')) {
                            ?>
                            <div class="d-flex gap-2 align-items-center flex-wrap float-end"><a href="#addleave" onclick="addLeave()" role="button" class="btn btn-primary btn-sm checkbox-toggle edit_setting" /> <i class="fa fa-plus"></i> <?php echo $this->lang->line('add_leave_request'); ?></a></div>
                        <?php } ?>
                    </div><!-- /.card-header -->
                    <div class="card-body">
                        <div class="row">
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
                    ...
                    <form role="form" id="leavedetails_form" action="">
                        ...
                        <div class="sh-form-card">
                            <div class="sh-card-header">
                                <span class="sh-card-header-title"><i class="fa fa-calendar-check-o"></i><?php echo $this->lang->line('approve_leave_request'); ?></span>
                            </div>
                            <div class="sh-info-grid">
                                <div class="row g-0">
                                    <div class="col-6 sh-info-item">
                                        <span class="sh-info-label"><i class="fa fa-user"></i><?php echo $this->lang->line('name'); ?></span>
                                        <span class="sh-info-value highlight"><span id="name"></span></span>
                                    </div>
                                    <div class="col-6 sh-info-item">
                                        <span class="sh-info-label"><i class="fa fa-paper-plane-o"></i><?php echo $this->lang->line('submitted_by'); ?></span>
                                        <span class="sh-info-value"><span id="appliedby"></span></span>
                                    </div>
                                </div>
                                <div class="row g-0 sh-row-divider">
                                    <div class="col-6 sh-info-item">
                                        <span class="sh-info-label"><i class="fa fa-tag"></i><?php echo $this->lang->line('leave_type'); ?></span>
                                        <span class="sh-info-value"><span id="leave_type"></span></span>
                                    </div>
                                    <div class="col-6 sh-info-item">
                                        <span class="sh-info-label"><i class="fa fa-calendar-check-o"></i><?php echo $this->lang->line('apply_date'); ?></span>
                                        <span class="sh-info-value"><span id="applied_date"></span></span>
                                    </div>
                                </div>
                                <div class="row g-0 sh-row-divider">
                                    <div class="col-6 sh-info-item">
                                        <span class="sh-info-label"><i class="fa fa-calendar-o"></i><?php echo $this->lang->line('leave'); ?></span>
                                        <span class="sh-info-value"><span id="leave_from"></span> &ndash; <span id="leave_to"></span> (<span id="days"></span>)</span>
                                    </div>
                                    <div class="col-6 sh-info-item">
                                        <span class="sh-info-label"><i class="fa fa-comment-o"></i><?php echo $this->lang->line('reason'); ?></span>
                                        <span class="sh-info-value"><span id="remark"></span></span>
                                    </div>
                                </div>
                                <div class="row g-0 sh-row-divider">
                                    <div class="col-12 sh-info-item sh-info-inline">
                                        <span class="sh-info-label"><i class="fa fa-paperclip"></i><?php echo $this->lang->line('download'); ?></span>
                                ...
                                <div class="row">
                                    <div class="col-md-7">
                                        <div class="mb-3 mb-md-0">
                                            <label><i class="fa fa-sticky-note-o text-muted me-1"></i><?php echo $this->lang->line('note'); ?> <small class="text-muted">(<?php echo $this->lang->line('only_display_for_admin'); ?>)</small></label>
                                            <div id="reason">
                                                <textarea class="form-control sh-no-resize" rows="2" id="detailremark" name="detailremark"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="mb-0">
                                            <label><i class="fa fa-flag-o text-muted me-1"></i><?php echo $this->lang->line('status'); ?></label>
                                            <div class="mt-1">
                                                <div class="sh-seg-status">
                                                    <label class="sh-seg-opt sh-seg-pending">
                                                        <input type="radio" value="pending" name="status" checked>
                                                        <span><?php echo $status["pending"]; ?></span>
                                                    </label>
                                                    <label class="sh-seg-opt sh-seg-approve">
                                                        <input type="radio" value="approve" name="status">
                                                        <span><?php echo $status["approve"]; ?></span>
                                                    </label>
                                                    <label class="sh-seg-opt sh-seg-disapprove">
                                                        <input type="radio" value="disapprove" name="status">
                                                        <span><?php echo $status["disapprove"]; ?></span>
                                                    </label>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-info submit_schsetting" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i>">
        ...
        <div class="modal-content">
            ...
            <form role="form" id="addleave_form" method="post" enctype="multipart/form-data" action="">
                <div class="pup-scroll-area">
                    <div class="modal-body p-2">
                        <div class="sh-form-card mb-2">
                            <div class="sh-card-header">
                                <span class="sh-card-header-title"><i class="fa fa-calendar-plus-o"></i><?php echo $this->lang->line('staff_leave_request'); ?></span>
                            </div>
                            <div class="p-2">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                        <div class="mb-3">
                                            <label><i class="fa fa-briefcase text-muted me-1"></i><?php echo $this->lang->line('staff_role'); ?></label><small class="req"> *</small>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                        <div class="mb-3">
                                            <label><i class="fa fa-user text-muted me-1"></i><?php echo $this->lang->line('staff_name'); ?></label><small class="req"> *</small>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                        <div class="mb-3">
                                            <label><i class="fa fa-calendar-check-o text-muted me-1"></i><?php echo $this->lang->line('apply_date'); ?></label><small class="req"> *</small>
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                        <div class="mb-3">
                                            <label><i class="fa fa-tag text-muted me-1"></i><?php echo $this->lang->line('leave_type'); ?></label><small class="req"> *</small>
                                            <div id="leavetypeddl">
                                    ...
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                        <div class="mb-3">
                                            <label><i class="fa fa-sign-out text-muted me-1"></i><?php echo $this->lang->line('leave_from_date'); ?></label><span class="req"> *</span>
                                            <div class="input-group">
                                                <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                                <input type="text" readonly name="leave_from_date" class="form-control float-end date" id="leave_from_date">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                        <div class="mb-3">
                                            <label><i class="fa fa-sign-in text-muted me-1"></i><?php echo $this->lang->line('leave_to_date'); ?></label><span class="req"> *</span>
                                            <div class="input-group">
                                                <div class="input-group-text"><i class="fa fa-calendar"></i></div>
                                                <input type="text" readonly name="leave_to_date" class="form-control float-end date" id="leave_to_date">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="sh-form-card">
                            <div class="sh-card-header">
                                <span class="sh-card-header-title"><i class="fa fa-pencil-square-o"></i><?php echo $this->lang->line('add_details'); ?></span>
                            </div>
                            <div class="p-2">
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                        <div class="mb-3">
                                            <label><i class="fa fa-comment-o text-muted me-1"></i><?php echo $this->lang->line('reason'); ?></label>
                                            <textarea name="reason" id="reason" class="form-control sh-no-resize" rows="4"></textarea>
                                            <input type="hidden" name="leaverequestid" id="leaverequestid">
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                        <div class="mb-3">
                                            <label><i class="fa fa-sticky-note-o text-muted me-1"></i><?php echo $this->lang->line('staff_note'); ?></label>
                                            <textarea class="form-control sh-no-resize" rows="4" id="remark" name="remark"></textarea>
                                            <span class="text-danger"><?php echo form_error('remark'); ?></span>
                                        </div>
                                    </div>
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-6">
                                        <div class="mb-3">
                                            <label><i class="fa fa-paperclip text-muted me-1"></i><?php echo $this->lang->line('attach_document'); ?></label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="d-none" id="clearform" onclick="clearForm(this.form)" class="btn btn-info submit_addLeave" data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i>"><?php echo $this->lang->line('clear'); ?></button>
                </div>
            </form>    
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $(document).on('hidden.bs.modal', '#addleave', function(){
     ...
     SHPicker.setDate('#applieddate', new Date()); // reset applied date to today on modal close
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                if (result.document_file) {
                    $("#download_file").html('<a href="' + base_url + 'admin/staff/download/' + result.id + '/' + result.staff_id + '" class="btn btn-outline-secondary btn-sm"><i class="fa fa-download"></i> <?php echo $this->lang->line('download'); ?></a>');
                } else {
                    $("#download_file").html('<span class="text-muted">&mdash;</span>');
                }
            }
        });
    ...
    function editRecord(id) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                // #reservation auto-initialized via .daterange class. Set range values:
                var reservationEl = document.getElementById('reservation');
                if (reservationEl) {
                    var inst = SHPicker.getInstance(reservationEl);
                    if (inst) {
                        inst.dates.setValue(new tempusDominus.DateTime(new Date(result.leave_from)));
                        inst.dates.setValue(new tempusDominus.DateTime(new Date(result.leave_to)));
                    }
                }
