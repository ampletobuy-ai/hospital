    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title titlefix"><?php echo $this->lang->line('staff_directory'); ?></h3>
                <div class="d-flex gap-2 align-items-center flex-wrap float-end">
                    <?php if ($this->rbac->hasPrivilege('staff', 'can_add')) { ?>
                        <div class="btn-group">
                            <a href="<?php echo site_url('admin/staff/create'); ?>" class="btn btn-primary btn-sm"><?php echo $this->lang->line('add_staff'); ?></a>
                            <?php if ($this->rbac->hasPrivilege('disable_staff', 'can_view')) { ?>
                                <button type="button" class="btn btn-primary dropdown-toggle btn-sm sh-split-btn" data-bs-toggle="dropdown">
                    ...
                    <?php if ($this->rbac->hasPrivilege('staff_payroll', 'can_view')) { ?>
                        <a href="<?php echo base_url(); ?>admin/payroll" class="btn btn-primary btn-sm">
                            <?php echo $this->lang->line('staff_payroll'); ?>
                        </a>
                    <?php } ?>
                    <?php if ($this->rbac->hasPrivilege('apply_leave', 'can_view')) { ?>
                        <a href="<?php echo base_url(); ?>admin/staff/leaverequest" class="btn btn-primary btn-sm">
                            <?php echo $this->lang->line('staff_leaves'); ?>
                        </a>
                    <?php } ?>
                </div>
            </div>
            <div class="card-body">
                    ...
                    <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="role" class="form-control">
                                    ...
                                    <?php foreach ($role as $key => $role_value) { ?>
                                        <option value="<?php echo $role_value['id']; ?>"<?php echo ($role_id == $role_value['id']) ? ' selected' : ''; ?>>
                        ...
                        <div class="col-sm-6 col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" name="search_text" class="form-control" value="<?php echo isset($search_text) ? html_escape($search_text) : ''; ?>" placeholder="<?php echo $this->lang->line('search_by_staff'); ?>">
                            </div>
                        </div>
                ...
                <div class="sh-results-toolbar">
                    <span class="sh-results-label"><?php echo $this->lang->line('staff_list'); ?></span>
                    <div class="sh-view-switch">
                        <button class="sh-vs-btn active" onclick="shStaffSwitchView('card', this)">
                            <?php echo $this->lang->line('card_view'); ?>
                        </button>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="sh-staff-card">
                                ...
                                <div class="sh-staff-card-actions">
                                    ...
                                    if ($a == 1) { ?>
                                        <a href="<?php echo base_url() . 'admin/staff/edit/' . $staff['id']; ?>" class="sh-btn-edit">
                            ...
                            <tr>
                                ...
                                <?php if (!empty($fields)) {
                                    foreach ($fields as $fields_value) {
                                        ...
                                        <td><?php echo ($fields_value->type == 'link') ? $display_field : html_escape($display_field); ?></td>
                                    <?php }
                                } ?>
                                <td class="text-end noExport">
                                    ...
                                    if ($a == 1) { ?>
                                        <a href="<?php echo base_url() . 'admin/staff/edit/' . $staff['id']; ?>" class="btn btn-secondary btn-sm" data-bs-toggle="tooltip" title="<?php echo $this->lang->line('edit'); ?>">
