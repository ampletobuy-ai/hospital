<div class="row clearfix">
                    ...
                    <tbody>
                            ...
                            <tr id='addr0'>
                                <td>
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="time_from_<?php echo $counter; ?>" class="form-control time_from timepicker" id="time_from_<?php echo $counter; ?>" value="<?php echo ($prev_rec_value->start_time != "") ? $prev_rec_value->start_time :  $prev_rec_value->start_time;?>">
                                ...
                                <td>
                                    <div class="input-group">
                                        <input type="text" name="time_to_<?php echo $counter; ?>" class="form-control time_to timepicker" id="time_to_<?php echo $counter; ?>" value="<?php echo ($prev_rec_value->end_time != "") ? $prev_rec_value->end_time :  $prev_rec_value->end_time;?>">
                                        <div class="input-group-text">
                                            <span class="fa fa-clock-o"></span>
                                        </div>
                                    </div>
                        ...
                        <tr id='addr0'>
                            <td>
                                ...
                                <div class="input-group">
                                    <input type="text" name="time_from_<?php echo $total_count; ?>" class="form-control time_from timepicker" id="time_from_<?php echo $total_count; ?>" aria-invalid="false">
                                    <div class="input-group-text">
                                        <span class="fa fa-clock-o"></span>
                                    </div>
                                </div>
                            ...
                            <td>
                                <div class="input-group">
                                    <input type="text" name="time_to_<?php echo $total_count; ?>" class="form-control time_to timepicker" id="time_to_<?php echo $total_count; ?>" aria-invalid="false">
                                    <div class="input-group-text">
                                        <span class="fa fa-clock-o"></span>
                                    </div>
                                </div>
    ...
    <?php } ?>
            ...
            <?php if ($this->rbac->hasPrivilege('online_appointment_slot', 'can_edit')) { ?>
                <button class="btn btn-primary btn-sm float-end" data-loading-text="<?php echo $this->lang->line('processing'); ?>" type="submit"><i class="fa fa-check-circle"></i> <?php echo $this->lang->line('save'); ?></button>
            <?php } ?>
          </form>
    </div>
</div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('form#form_' + form_id).find('[type=submit]').btnLoading();
            ...
            if ($('form#form_' + form_id).validate().form()) {
                var target = $('.nav-tabs a.active').attr("href");
                var target_id = $('.nav-tabs a.active').attr("id");
                var ajax_data = $('.nav-tabs a.active').data();

                $.ajax({
                    type: 'POST',
                    url: base_url + "admin/onlineappointment/saveDoctorShift",
                    data: $('#form_' + form_id).serialize()
                        + '&doctor='       + encodeURIComponent(ajax_data.d)
                        + '&shift='        + encodeURIComponent(ajax_data.s)
                        + '&day='          + encodeURIComponent(ajax_data.day)
                        + '&consult_time=' + encodeURIComponent($('#consult_time').val())
                        + '&charge_id='    + encodeURIComponent($('.charge').val()),
                    dataType: 'json',
                    beforeSend: function () {
                    ...
                    success: function (data) {
                        ...
                        $('form#form_' + form_id).find('[type=submit]').btnReset();
                    },
