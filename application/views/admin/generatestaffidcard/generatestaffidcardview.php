    ...
    <div class="col-md-12">
        <div class="sh-form-card">
            <div class="card-header ptbnull d-flex align-items-center">
                <h3 class="card-title"><?php echo $this->lang->line('generate_staff_id_card'); ?></h3>
                <?php if (($this->rbac->hasPrivilege('staff_id_card', 'can_view'))) { ?>
                <a class="btn btn-info btn-sm ms-auto" type="button" href="<?php echo base_url('admin/staffidcard/'); ?>" title="<?php echo $this->lang->line('id_card_template'); ?>"><i class="fa fa-newspaper-o ftlayer"></i> <?php echo $this->lang->line('id_card_template'); ?></a>
                <?php } ?>
            </div>
            <div class="p-3">
                <form role="form" id="form1"  method="post" class="row">
            ...
            <form method="post" action="<?php echo base_url('admin/generatestaffidcard/generatemultiple') ?>">
                ...
                <div id="duefee">
                    ...
                    <div class="card-header ptbnull d-flex align-items-center mb5">
                        <h3 class="card-title"><?php echo $this->lang->line('staff_list'); ?></h3>
            ...
            success: function (data) {
                ...
                if (data.status == "fail") {
                   ...
                   $('#idcard').val(data.param.id_card);
                    $("#error_role_id").html('');
                    $("#error_id_card").html('');
                    initDatatable('allajaxlist', 'admin/generatestaffidcard/getstafflistdatatable/',data.param,[],100,[{ "sWidth": "40px", "bSortable": false, "aTargets": [ 0 ] ,'sClass': 'dt-body-left'}]);
                }
            }
        });
        }
