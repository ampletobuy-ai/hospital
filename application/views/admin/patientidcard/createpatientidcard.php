                ...
                <div class="col-md-4">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?php echo $this->lang->line('add_patient_id_card'); ?></h3>
                        </div><!-- /.card-header -->
                        <!-- form start -->
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-3 d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="form-check form-switch d-inline-flex m-0">
                                        <input id="enable_patient_name" name="is_active_patient_name" type="checkbox" role="switch" class="form-check-input chk" value="1">
                                    </div>
                                </div>
                                <div class="mb-3 d-flex align-items-center justify-content-between">
                                    <label class="form-label"><?php echo $this->lang->line('patient_id'); ?></label>
                                    <div class="form-check form-switch d-inline-flex m-0">
                                        <input id="enable_patient_unique_id" name="is_active_patient_unique_id" type="checkbox" role="switch" class="form-check-input chk" value="1">
                                    </div>
                                </div>
                                <div class="mb-3 d-flex align-items-center justify-content-between">
                                    <label class="form-label"><?php echo $this->lang->line('guardian_name'); ?></label>
                                    <div class="form-check form-switch d-inline-flex m-0">
                                        <input id="enable_guardian_name" name="is_active_guardian_name" type="checkbox" role="switch" class="form-check-input chk" value="1">
                                    </div>
                                </div>
                                <div class="mb-3 d-flex align-items-center justify-content-between">
                                    <label class="form-label"><?php echo $this->lang->line('patient_address'); ?></label>
                                    <div class="form-check form-switch d-inline-flex m-0">
                                        <input id="enable_address" name="is_active_address" type="checkbox" role="switch" class="form-check-input chk" value="1">
                                    </div>
                                </div>
                                <div class="mb-3 d-flex align-items-center justify-content-between">
                                    <label class="form-label"><?php echo $this->lang->line('phone'); ?></label>
                                    <div class="form-check form-switch d-inline-flex m-0">
                                        <input id="enable_phone" name="is_active_phone" type="checkbox" role="switch" class="form-check-input chk" value="1">
                                    </div>
                                </div>
                                <div class="mb-3 d-flex align-items-center justify-content-between">
                                    <label class="form-label"><?php echo $this->lang->line('date_of_birth'); ?></label>
                                    <div class="form-check form-switch d-inline-flex m-0">
                                        <input id="enable_dob" name="is_active_dob" type="checkbox" role="switch" class="form-check-input chk" value="1">
                                    </div>
                                </div>
                                <div class="mb-3 d-flex align-items-center justify-content-between">
                                    <label class="form-label"><?php echo $this->lang->line('blood_group'); ?></label>
                                    <div class="form-check form-switch d-inline-flex m-0">
                                        <input id="enable_blood_group" name="is_active_blood_group" type="checkbox" role="switch" class="form-check-input chk" value="1">
                                    </div>
                                </div>
                                <div class="mb-3 d-flex align-items-center justify-content-between">
                                    <label class="form-label"><?php echo $this->lang->line('barcode_qrcode'); ?></label>
                                    <div class="form-check form-switch d-inline-flex m-0">
                                        <input id="enable_barcode" name="is_active_barcode" type="checkbox" role="switch" class="form-check-input chk" value="1">
                                    </div>
                                </div>                                
                            </div><!-- /.card-body -->
                                        ...
                                        foreach ($idcardlist as $idcard) {
                                            ...
                                            <tr>
                                                <td class="mailbox-name">
                                                    <a id="<?php echo $idcard->id ?>" data-bs-toggle="popover" class="detail_popover view_data sh-cursor-pointer" ><?php echo $idcard->title; ?></a>
                                                </td>
                                                <td class="mailbox-name">
