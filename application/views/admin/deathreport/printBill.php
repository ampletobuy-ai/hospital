            ...
            <div class="col-md-12">
                <div class="">
                    ...
                    <table width="100%" class="printablea4">
                        <tr>
                            <td class="text-start"><?php echo $this->lang->line('bill') . " #"; ?><?php echo $result["bill_no"] ?>
                            </td>
                            <td class="text-end"><?php echo $this->lang->line('date') . " : "; ?><?php echo date($this->customlib->getHospitalDateFormat(true, true), strtotime($result['date'])) ?>
                            </td>
                        </tr>
                    </table>
                    ...
                    <table class="printablea4" width="100%">
                        <?php if (!empty($result["total"])) {?>
                            <tr>
                                ...
                                <td class="text-start" width="80%"><?php echo $result["total"]; ?></td>
                            </tr>
                        <?php }?>
...
echo $this->lang->line('discount') . " (" . $currency_symbol . ")";
    ...
    ?></th>
                                ...
                                <td class="text-start"><?php echo $result["discount"]; ?></td>
...
echo $this->lang->line('tax') . " (" . $currency_symbol . ")";
    ...
    ?></th>
                                ...
                                <td class="text-start"><?php echo $result["tax"]; ?></td>
...
echo $this->lang->line('net_amount') . " (" . $currency_symbol . ")";
        ...
        ?></th>
                                    ...
                                    <td class="text-start"><?php echo $result["net_amount"]; ?></td>
...
?>
                        <?php if (!empty($result["note"])) {?>
                            <tr>
                                ...
                                <td class="text-start"><?php echo $result["note"]; ?></td>
                            </tr>
                        <?php }?>
                    </table>
                    <div class="divider mb-10 mt-10"></div> 
