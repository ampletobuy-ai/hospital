            ...
            <div class="col-md-12">
                <div class="">
                    ...
                    <table width="100%" class="printablea4">
                        <tr>
                            <td class="text-start"><?php echo $this->lang->line('report') . "# "; ?><?php echo $result["bill_no"] ?></td>
                            <td class="text-end"><?php echo $this->lang->line('date') . " : "; ?><?php echo date($this->customlib->getHospitalDateFormat(true, false), strtotime($result['reporting_date'])) ?></td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            ...
                            ?>
                                ...
                                <td><?php if (!empty($bill["radiology_report"])) { ?>
                                        <a <?php if($print != 'yes'){ ?> href="<?php echo base_url(); ?>admin/radio/download/<?php echo $bill["radiology_report"]; ?>" <?php } ?> class="btn btn-secondary btn-sm"  data-bs-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>">
