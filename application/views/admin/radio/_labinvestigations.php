...
<table class="table table-striped table-bordered noborder">
    <tbody>
        ...
        <tr>               
           ...
           <td>
               <a href="<?php echo site_url('admin/radio/downloadReport/'.$result->id) ?>" class='btn btn-secondary btn-sm' data-bs-toggle='tooltip' title='<?php echo $this->lang->line('download'); ?>'><i class="fa fa-download"></i></a>
           </td>
            <?php } ?>
        </tr>
    </tbody>
