        ...
        <div class="row g-2">
            ...
            <div class="col-sm-3">
                <div class="mb-3">
                    ...
                    <input readonly class="form-control form-control-sm" name="tax" id="tax">
            ...
            <div class="col-sm-3">
                <div class="mb-3">
                    ...
                    <input readonly class="form-control form-control-sm" name="amount" id="amount">
            ...
            <table class="table table-sm table-bordered table-hover mb-0" id="tableID">
                ...
                <tbody>
                    <tr id="row0">
                        ...
                        <td width="35%">
                            <select class="form-control form-control-sm select2 radiology_parmeter check_dublicate w-100" id="parameter_name_1" name="parameter_name_1">
                        ...
                        <td width="30%">
                            <input type="text" readonly name="radio_unit_1" id="radio_unit_" class="form-control form-control-sm radio_unit">
                        </td>
