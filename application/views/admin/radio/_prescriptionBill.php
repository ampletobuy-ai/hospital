            ...
            <table class="table table-sm table-striped table-bordered table-hover tblProducts sh-radio-edit-table mb-0" id="tableID">
                ...
                <tbody>
                    ...
                    <tr id="row<?php echo $counter; ?>">
                        ...
                        <td>
                            <input type="text" name="reportdate_<?php echo $counter; ?>" id="reportdate_<?php echo $counter; ?>" value="<?php echo ($date == "") ? "" : $this->customlib->strtotimeToDateFormat($date + ($test_value->radio_report_days * 86400)); ?>" class="form-control form-control-sm text-end report_date">
