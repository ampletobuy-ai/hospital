<?php
$pg_layout   = isset($result['layout_type'])       ? $result['layout_type']       : 'blank';
$pg_raw      = isset($result['page_section_data'])  ? $result['page_section_data']  : '{}';
$pg_sections = json_decode($pg_raw, true) ?: array();
$pg_faq_items = (isset($pg_sections['faq']) && is_array($pg_sections['faq'])) ? array_values($pg_sections['faq']) : array();
?>
...
<!-- Content Header (Page header) -->
    ...
    <!-- Main content -->
    <form id="form1" action="<?php echo site_url('admin/front/page/edit/' . $result['slug']) ?>" enctype="multipart/form-data" name="employeeform" method="post" accept-charset="utf-8">
        <div class="row">
                <div class="col-md-9">
                    <!-- Horizontal Form -->
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="card-title titlefix"><?php echo $this->lang->line('edit_page'); ?></h3>
                        </div><!-- /.card-header -->
                        <!-- form start -->
                        <div class="card-body">
...
?>
                            ...
                            <div class="mb-3">
                                ...
                                <?php foreach ($category as $cat_key => $cat_value) {
                                    ...
                                    <div class="form-check form-check-inline m-0">
                                        <input class="form-check-input" type="radio" id="<?php echo $radio_id; ?>" value="<?php echo $cat_key ?>" name="content_category" <?php echo set_checkbox('content_category', $cat_key, set_value('content_category', in_array($cat_key, $result['category_content'])) ? true : false); ?> >
                    ...
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            ...
                            <button type="button" class="btn btn-sm btn-box-tool ms-auto card-box-toggle" data-bs-target="#seoDetailBody" title="<?php echo $this->lang->line('collapse'); ?>"><i class="fa fa-minus"></i></button>
                        </div>
                        <div id="seoDetailBody">
                        <div class="card-body">
                            <div class="mb-3">
                                <label for="exampleInputEmail1"><?php echo $this->lang->line('meta_title'); ?></label>
                                <input id="meta_title" name="meta_title" placeholder="" type="text" class="form-control"  value="<?php echo html_escape(set_value('meta_title', $result['meta_title'])); ?>" />
                            ...
                            <div class="mb-3">
                                ...
                                <input id="meta_keywords" name="meta_keywords" placeholder="" type="text" class="form-control"  value="<?php echo html_escape(set_value('meta_keywords', $result['meta_keyword'])); ?>" />
                            ...
                            <div class="mb-3">
                                ...
                                <textarea id="editor1" name="meta_description" placeholder="" type="text" class="form-control" ><?php echo html_escape(set_value('meta_description', $result['meta_description'])); ?></textarea>
                                <span class="text-danger"><?php echo form_error('meta_description'); ?></span>
                            </div>
                        </div>
                        </div><!-- /#seoDetailBody collapse -->
                    </div>
                </div><!--/.col (right) -->
                <!-- left column -->
