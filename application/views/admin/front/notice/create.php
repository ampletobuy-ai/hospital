...
<!-- Content Header (Page header) -->
    <!-- Main content -->
    <form id="form1" action="<?php echo site_url('admin/front/notice/create') ?>" enctype="multipart/form-data" name="employeeform" method="post" accept-charset="utf-8">
    <div class="row">
                <div class="col-md-9">
                    <!-- Horizontal Form -->
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="card-title titlefix"><?php echo $this->lang->line('add_news'); ?></h3>
                        </div><!-- /.card-header -->
                        <!-- form start -->
                        <div class="card-body">
