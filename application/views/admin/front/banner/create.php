                ...
                <div class="col-md-9">
                    ...
                    <div class="card">
                        <div class="card-header d-flex align-items-center">
                            <h3 class="card-title mb-0"><?php echo $this->lang->line('add_gallery'); ?></h3>
                        </div><!-- /.card-header -->
                        <!-- form start -->
                        <div class="card-body">
...
?>
                            ...
                            <div class="mb-3"> <!-- Submit button !-->
                                <button type="button" class="btn btn-primary" id="media_images" data-bs-toggle="modal" data-bs-target="#mediaModal"><i class="fa fa-plus"></i>
