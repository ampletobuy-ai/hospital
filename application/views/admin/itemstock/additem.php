            ...
            <div class="col-md-4">
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><?php echo $this->lang->line('add_item'); ?></h3>
                    </div><!-- /.card-header -->
...
?>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="description" name="description" placeholder="" rows="3" placeholder="<?= $this->lang->line('enter') ?>"><?php echo set_value('description'); ?></textarea>
...
if ($items['description'] == "") {
            ...
            ?>
                                                            <p class="text text-info"><?php echo html_escape($items['description']); ?></p>
                                                            <?php
}
        ?>
                                                    </div>
                                                ...
                                                <td class="mailbox-date float-end">
                                                    <a href="<?php echo base_url(); ?>admin/item/add/<?php echo $items['id'] ?>" class="btn btn-secondary btn-sm"  data-bs-toggle="tooltip" title="<?php echo $this->lang->line('add'); ?>">
