            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="card-title"><?php echo $this->lang->line('medicine_purchase_report'); ?></h3>
                    </div>
                    ...
                    <div class="card-body table-responsive pt-0">
                        <div class="download_label"><?php echo $this->lang->line('medicine_purchase_report'); ?></div>
                            <table class="table table-striped table-bordered table-hover allajaxlist"
                                   data-export-title="<?php echo $this->lang->line('medicine_purchase_report'); ?>">
                                <thead>
                                    <tr>
...
<script>
    ...
    $(document).ready(function () {
        $('#form1').on('submit', function (e) {
            ...
            $.ajax({
                url: '<?php echo base_url(); ?>admin/expmedicine/medicinepurchasecheckvalidation',
                type: "POST",
                data: formData,
                dataType: 'json',
                contentType: false,
                ...
                success: function (data) {
                    if (data.status == "fail") {
                        ...
                        initDatatable('allajaxlist', 'admin/expmedicine/medicinepurchasereports/', data.param, [], 100);
                    }
                }
            });
        });
