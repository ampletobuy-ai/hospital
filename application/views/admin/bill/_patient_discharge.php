...
?>
<div class="p-1">
    <form id="form_patient_discharge" accept-charset="utf-8" action="<?php echo base_url() ?>admin/bill/add_discharge" method="post" enctype="multipart/form-data">
        ...
        <input type="hidden" name="case_reference_id" value="<?php echo $case_id; ?>">

        <div class="alert alert-warning mb-2"><?php echo $this->lang->line("please_note_that_before_discharging_check_patient_bill"); ?></div>

        <div class="sh-form-card mb-2">
            <div class="sh-card-header">
                <span class="sh-card-header-title"><?php echo $this->lang->line('discharge_card'); ?></span>
            </div>
            <div class="p-2">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-2">
                            <label class="form-label"><?php echo $this->lang->line('discharge_date'); ?></label><small class="req"> *</small>
                    ...
                    <div class="col-md-6">
                        <div class="mb-2">
                            <label class="form-label"><?php echo $this->lang->line('discharge_status'); ?></label><small class="req"> *</small>
                    ...
                    <div class="col-sm-6">
                        <div class="mb-2">
                            <label class="form-label"><?php echo $this->lang->line('operation'); ?></label>
                    ...
                    <div class="col-sm-6">
                        <div class="mb-2">
                            <label class="form-label"><?php echo $this->lang->line('diagnosis'); ?></label>
                    ...
                    <div class="col-sm-6">
                        <div class="mb-2">
                            <label class="form-label"><?php echo $this->lang->line('investigation'); ?></label>
                    ...
                    <div class="col-sm-6">
                        <div class="mb-2">
                            <label class="form-label"><?php echo $this->lang->line('treatment_home'); ?></label>
                ...
                <!-- Death Record (shown when discharge_status == 1) -->
                <div class="row death_status_div d-none" >
                    <div class="col-md-6">
                        <div class="mb-2">
                            <label class="form-label"><?php echo $this->lang->line('death_date'); ?></label><small class="req"> *</small>
                            <input type="text" value="<?php if ((!empty($discharge_card)) && $discharge_card['death_date'] != '') {echo $this->customlib->YYYYMMDDHisTodateFormat($discharge_card['death_date'], $this->time_format);}?>" name="death_date" id="death_date" class="form-control datetime">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="mb-2">
                            <label class="form-label"><?php echo $this->lang->line('guardian_name'); ?></label><small class="req"> *</small>
                    ...
                    <div class="col-12">
                        <div class="mb-2">
                            <label class="form-label"><?php echo $this->lang->line('attachment'); ?></label>
                ...
                <!-- Referral Details (shown when discharge_status == 2) -->
                <div class="row reffer_div d-none" >
                    <div class="col-md-6">
                        <div class="mb-2">
                            <label class="form-label"><?php echo $this->lang->line('referral_date'); ?></label><small class="req"> *</small>
                    ...
                    <div class="col-md-6">
                        <div class="mb-2">
                            <label class="form-label"><?php echo $this->lang->line('referral_hospital_name'); ?></label><small class="req"> *</small>
                    ...
                    <div class="col-md-6">
                        <div class="mb-2">
                            <label class="form-label"><?php echo $this->lang->line('reason_for_referral'); ?></label>
        ...
        <input type="hidden" id="discharge_card_exists" value="<?php echo empty($discharge_card) ? '0' : '1'; ?>">
    </form>
</div>
...
<script type="text/javascript">
    ...
    var download = ' <a data-bs-toggle="tooltip" title="<?php echo $this->lang->line('download'); ?>" href="<?php echo site_url('admin/birthordeath/download_deathrecord/' . $deathrecord['id']); ?>" data-recordId="" class="btn btn-sm btn-light"><i class="fa fa-download"></i></a> ';
    <?php } ?>
    <?php if ((!empty($discharge_card))) { ?>
    $('#allpayments_print').html('<a href="javascript:void(0);" data-bs-toggle="tooltip" title="<?php echo $this->lang->line('print'); ?>" class="print_dischargecard btn btn-sm btn-light" data-recordId="<?php echo $discharge_card['id']; ?>" data-case_id="<?php echo $case_id; ?>"><i class="fa fa-print"></i></a>' + download);
    <?php } ?>
</script>
