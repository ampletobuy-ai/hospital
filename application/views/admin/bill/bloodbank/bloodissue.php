            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title titlefix"><?php echo $this->lang->line('blood_issue_billing'); ?></h3>
                            ...
                            <table class="table table-striped table-bordered table-hover ajaxlist" width="100%" data-export-title="<?php echo $this->lang->line('blood_issue_billing'); ?>">
                                <thead>
                                    <tr>  
                                        ...
                                        <th class="white-space-nowrap"><?php echo $this->lang->line('issue_date'); ?></th>
                                        <th class="white-space-nowrap"><?php echo $this->lang->line('received_to'); ?></th>
                                        <th class="white-space-nowrap"><?php echo $this->lang->line('blood_group'); ?></th>
                                        <th class="white-space-nowrap"><?php echo $this->lang->line('gender'); ?></th>
                                        <th class="white-space-nowrap"><?php echo $this->lang->line('donor_name'); ?></th>
                                        <th class="white-space-nowrap"><?php echo $this->lang->line('bags'); ?></th>
										...
										<th class="text-end white-space-nowrap"><?php echo $this->lang->line('paid_amount'). ' (' . $currency_symbol . ')'; ?></th>
        ...
        <div class="modal-content">
            <form id="formedit" accept-charset="utf-8" method="post">
                <div class="modal-header gap-2">
                    <h5 class="modal-title" id="myModaleditLabel"><?php echo $this->lang->line('edit'); ?> <?php echo $this->lang->line('issue_blood'); ?></h5>
...
<script type="text/javascript">
   ...
   $("#formadd").on('submit', (function (e) {
            ...
            // Client-side validation — charge category & charge name are mandatory.
            var charge_category_val = $.trim($("#formadd [name='charge_category']").val() || "");
            var charge_name_val     = $.trim($("#formadd [name='charge_id']").val() || "");
            var validation_msg = "";
            if (charge_category_val === "") {
                validation_msg += "<?php echo $this->lang->line('charge_category'); ?> <?php echo $this->lang->line('required'); ?>. ";
            }
            if (charge_name_val === "") {
                validation_msg += "<?php echo $this->lang->line('charge_name'); ?> <?php echo $this->lang->line('required'); ?>.";
            }
            if (validation_msg !== "") {
                errorMsg(validation_msg);
                return false;
            }
            ...
            sub_btn_clicked.btnLoading() ; 
                ...
                success: function (data) {
                    if (data.status == "fail") {
                        ...
                        errorMsg($.trim(message) || "<?php echo $this->lang->line('error_occurred_please_try_again'); ?>");
                    } else {
                        successMsg(data.message);
                ...
                error: function (xhr) {
                    // Surface the real server response instead of failing silently —
                    // a PHP warning/notice makes the response non-JSON and lands here,
                    // which previously showed nothing (looked like "validation not firing /
                    // not saving"). Now the actual error text is shown to the user.
                    var resp = (xhr && xhr.responseText) ? xhr.responseText : "";
                    errorMsg(resp ? resp.replace(/<[^>]*>/g, " ").substring(0, 500) : "<?php echo $this->lang->line('error_occurred_please_try_again'); ?>");
                    sub_btn_clicked.btnReset() ;
                },
                complete: function() {
                   sub_btn_clicked.btnReset() ; 
    ...
    $(document).ready(function () {
        initDatatable('ajaxlist','admin/bill/getbloodissueDatatable',[],[],100,
                        [
                          ...
                          { "aTargets": [ -2,-3,-4,-5,-6 ], 'sClass': 'dt-body-right'},
                          { "aTargets": [ 0,1,2 ], 'sClass': 'dt-body-left'},
                          { "aTargets": [ 5,6 ], 'sClass': 'dt-body-left'}
                        ]);
    });
} ( jQuery ) )
</script> 
