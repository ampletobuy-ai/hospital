        ...
        <div class="row g-2">
            <div class="col-sm-3">
                <div class="mb-2">
                    ...
                    <span class="text-danger small"><?php echo form_error('date_of_issue'); ?></span>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="mb-2">
                    <label class="form-label small"><?php echo $this->lang->line('hospital_doctor'); ?></label>
                    <select name='consultant_doctor' id="consultant_doctor" onchange="get_Docname(this.value)" class="form-control form-control-sm select2 w-100" <?php if ($disable_option == true) { echo "disabled"; } ?>>
                    ...
                    <span class="text-danger small"><?php echo form_error('refference'); ?></span>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="mb-2">
                    ...
                    <span class="text-danger small"><?php echo form_error('reference'); ?></span>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="mb-2">
            ...
            <div class="col-sm-3">
                <div class="mb-2">
                    ...
                    <select class="w-100 form-control form-control-sm select2 blood_group" id="component_blood_group" name="blood_group">
                        <option value=""><?php echo $this->lang->line('select'); ?></option>
            ...
            <div class="col-sm-3">
                <div class="mb-2">
                    <label class="form-label small"><?php echo $this->lang->line('components'); ?></label>
                    <select class="w-100 form-control form-control-sm select2 component_issue" id="blood_component" name="blood_component">
                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                    </select>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="mb-2">
                    ...
                    <select class="w-100 form-control form-control-sm select2 bag_no_issue" name="bag_no">
                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                    </select>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="mb-2">
                    ...
                    <select name="charge_category" id="charge_category" class="w-100 form-control form-control-sm select2 charge_category">
                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                    </select>
                    <span class="text-danger small"><?php echo form_error('charge_category'); ?></span>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="mb-2">
                    <label class="form-label small"><?php echo $this->lang->line('charge_name'); ?> <small class="req">*</small></label>
                    <select name="charge_id" id="code" class="w-100 form-control form-control-sm addcharge select2">
                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                    </select>
                    <span class="text-danger small"><?php echo form_error('code'); ?></span>
                </div>
            </div>
            <div class="col-sm-3">
                <div class="mb-2">
                    ...
                    <span class="text-danger small"><?php echo form_error('standard_charge'); ?></span>
                </div>
            </div>
            <div class="col-sm-3 hide">
                <div class="mb-2">
                    <label class="form-label small"><?php echo $this->lang->line('qty'); ?> <small class="req">*</small></label>
                    <input type="text" name="qty" id="qty" class="form-control form-control-sm">
                    <span class="text-danger small"><?php echo form_error('qty'); ?></span>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="sh-flex-col-260">
        <div class="sh-form-card h-100">
            ...
            <div class="px-2 py-3">
                ...
                <div class="mt-2"><?php echo display_custom_fields('component_issue'); ?></div>
            </div>
        </div>
    </div>
    <div class="sh-flex-col-260">
        <div class="sh-form-card h-100 overflow-hidden">
            ...
            <div class="sh-summary-row border-bottom">
                ...
                <div class="d-flex align-items-center gap-1">
                    ...
                    <input type="text" value="0" name="discount" id="discount" class="form-control form-control-sm text-end discount" style="width:130px;">
                </div>
            </div>
            <div class="sh-summary-row border-bottom">
                ...
                <div class="d-flex align-items-center gap-1">
                    ...
                    <input type="text" value="0" name="tax" id="tax" class="form-control form-control-sm text-end tax" style="width:130px;" readonly>
                </div>
            </div>
            ...
            <div class="px-2 py-3">
                <div class="row g-2">
                    <div class="col-6">
                        ...
                        <span class="text-danger small"><?php echo form_error('payment_mode'); ?></span>
                    </div>
                    <div class="col-6">
