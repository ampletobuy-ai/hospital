        ...
        <div class="row g-2">
            ...
            <div class="col-sm-3">
                <div class="mb-2">
                    ...
                    <select class="w-100 form-control form-control-sm select2 blood_group" name="blood_group">
                        <option value=""><?php echo $this->lang->line('select'); ?></option>
            ...
            <div class="col-sm-3">
                <div class="mb-2">
                    ...
                    <select class="w-100 form-control form-control-sm select2 bag_no" name="bag_no">
                        <option value=""><?php echo $this->lang->line('select'); ?></option>
                    </select>
                </div>
            </div>
