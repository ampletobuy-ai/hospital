...
<div class="row cheque_div d-none" >
                           ...
                           <button type="submit" data-loading-text="<?php echo $this->lang->line('processing') ?>" class="btn btn-info float-end"><?php echo $this->lang->line('save'); ?></button>
                        </form>
                    </div>
                </div>
...
<tr>
	...
	<td><a href='javascript:void(0)' data-loading-text='<i class="fa fa-circle-o-notch fa-spin"></i>' data-record-id="<?php echo $transaction->id;?>" class='btn btn-secondary btn-sm print_receipt'  data-bs-toggle='tooltip' title='<?php echo $this->lang->line("print"); ?>'><i class='fa fa-print'></i></a>
