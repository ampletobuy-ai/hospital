                ...
                <div class="col-md-4">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?php echo $this->lang->line('edit_custom_field'); ?></h3>
                        </div><!-- /.card-header -->
                        ...
                        <div class="row">                             
                            <div class="col-md-6">
                                 <label class="form-label"><?php echo $this->lang->line('validation'); ?></label>
                            </div>
                            <div class="col-md-6">                                
                                    ...
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="panel-title">
                                                <a data-bs-toggle="collapse" data-parent="#accordion" href="#collapse<?php echo $custom_field_table_key ?>"><i class="more-less fa fa-plus"></i><?php echo $custom_field_table_value; ?></a>
                                            </h4>
                                        </div>
