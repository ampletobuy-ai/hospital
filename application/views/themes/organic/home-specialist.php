...
<section class="hero-fb">
  ...
  <div class="container hero-fb-content">
    <div class="hero-fb-l">
      <span class="hero-fb-badge"><span class="dot"></span><?php echo html_escape($hero['badge_text'] ?? 'Specialist · Multi-disciplinary'); ?></span>
      <h1><?php echo html_escape($hero['headline'] ?? 'Specialists who listen first'); ?></h1>
      <p class="hero-fb-lede"><?php echo html_escape($hero['subheadline'] ?? 'A team of consultants across disciplines, working together on your care plan.'); ?></p>
