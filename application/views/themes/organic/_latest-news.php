...
?>
<div class="hero-fb-news">
  <div class="hero-fb-news-head">
  ...
  <ul class="hero-fb-news-list">
    ...
    ?>
    <li>
      <a href="<?php echo $url; ?>" class="hero-fb-news-item">
        <?php if ($d): ?>
        <div class="hero-fb-news-date"><?php echo html_escape($day_num); ?><small><?php echo html_escape($month_str); ?></small></div>
        <?php endif; ?>
        <div class="hero-fb-news-body">
          <div class="hero-fb-news-title"><?php echo html_escape(isset($n['title']) ? $n['title'] : ''); ?></div>
          <div class="hero-fb-news-meta"><?php echo $this->lang->line('read_more'); ?>
