...
<section class="hero-fb">
  ...
  <div class="container hero-fb-content">
    <div class="hero-fb-l">
      ...
      <span class="hero-fb-badge"><span class="dot"></span><?php echo html_escape($hero['badge_text']); ?></span>
      <?php endif; ?>
      <h1><?php echo html_escape($hero['headline'] ?? 'A kinder kind of visit'); ?></h1>
      <p class="hero-fb-lede"><?php echo html_escape($hero['subheadline'] ?? ''); ?></p>
