...
<section class="hero-fb">
  ...
  <div class="container hero-fb-content">
    <div class="hero-fb-l">
      <span class="hero-fb-badge"><span class="dot"></span><?php echo html_escape($hero['badge_text'] ?? 'Ophthalmology · 20/20 care'); ?></span>
      <h1><?php echo html_escape($hero['headline'] ?? 'See clearly, live softly'); ?></h1>
      <p class="hero-fb-lede"><?php echo html_escape($hero['subheadline'] ?? 'Eye care that takes its time — comprehensive checks, lens advice, and surgical precision.'); ?></p>
