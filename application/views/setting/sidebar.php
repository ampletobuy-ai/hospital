<div class="col-md-2">
    <div class="card border0">
        <ul class="tablists"> 
			...
			<?php if($this->rbac->hasPrivilege('theme_studio', 'can_view')) { ?>
                <li><a class="<?php echo set_Innermenu('admin/themestudio'); ?>" href="<?php echo base_url(); ?>admin/themestudio"><?php echo $this->lang->line('theme_studio'); ?></a></li>
            <?php } ?>

            <div class="tablists-divider"></div>
           ...
           if ($this->module_lib->hasModule('whatsapp_messaging') && $this->module_lib->hasActive('whatsapp_messaging')) {
            if($this->rbac->hasPrivilege('whatsapp_setting', 'can_view')) { ?>
                <li><a class="<?php echo set_Innermenu('whatsappconfig/index'); ?>" href="<?php echo base_url(); ?>whatsappconfig"><?php echo $this->lang->line('whatsapp_setting'); ?></a></li>
		   <?php } }
            } ?>
            ...
            <?php if ($this->rbac->hasPrivilege('general_setting', 'can_view')) { ?>
                <li class="<?php echo set_Innermenu('schsettings/queueprocess'); ?>"><a class="<?php echo set_Innermenu('schsettings/queueprocess'); ?>" href="<?php echo base_url(); ?>schsettings/queueprocess">Queue Process</a></li>
            <?php } ?>
