...
class Customlib
{
	...
	public function getFolderPath()
    {
		...
		if ($admin) {
			...
			$folder_path = isset($setting_result[0]["folder_path"]) ? $setting_result[0]["folder_path"] : '';
		}	
			
        // Empty/null folder_path → app root (FCPATH). Relative paths break barcode/QR writes under Apache.
  ...
  public function get_pending_staff_forms()
    ...
    {
        return $this->CI->config->item('product_name') ?: 'Qubex Track';
    }
